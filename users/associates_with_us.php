...
<body class="hold-transition sidebar-mini">
    <div class="wrapper"> <?php include "navbar.php"; ?> <?php include "aside.php"; ?>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <ul class="nav nav-pills ml-auto p-2">
                                        <li class="nav-item"><a class="nav-link active" href="ngo_form.php">Add NGO's
                                                Details</a></li>
                                    </ul>
                                </div> <!-- /.card-header -->
        ...
        <footer class="main-footer">
            <div class="float-right d-none d-sm-block"> <b>Version</b> 3.2.0 </div> <strong>Copyright &copy; 2014-2021
