                    ...
                    <div class="row">
                        <div class="col-lg-4 col-12">
                            <div class="small-box bg-info">
                                <div class="inner">
                                    <h5>National Committee</h5>
                                </div>
                                <div class="icon"> <i class="ion ion-bag"></i> </div> <a href="national_committee.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-12">
                            <div class="small-box bg-success">
                                <div class="inner">
                                    <h5>State Committee</h5>
                                </div>
                                <div class="icon"> <i class="ion ion-stats-bars"></i> </div> <a href="national_committee.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-12">
                            <div class="small-box bg-warning">
                                <div class="inner">
                                    <h5>State Regional Committee</h5>
                                </div>
                                <div class="icon"> <i class="ion ion-person-add"></i> </div> <a href="national_committee.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-12">
                            <div class="small-box bg-danger">
                                ...
                                <div class="icon"> <i class="ion ion-pie-graph"></i> </div> <a href="national_committee.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-12">
                            <div class="small-box bg-gray">
                                <div class="inner">
                                    <h5>Taluka Committee</h5>
                                </div>
                                <div class="icon"> <i class="ion ion-bag"></i> </div> <a href="national_committee.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
