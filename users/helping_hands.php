...
<head>
    ...
    <title>Helping Hands</title> <!-- Google Font: Source Sans Pro -->
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Helping Hands</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                                ...
                                <div class="card bg-light d-flex flex-fill">
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="row">
                                            ...
                                            <div class="col-5 text-center"> <img src="dist/img/user1-128x128.jpg" alt="user-avatar" class="img-circle img-fluid"> </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card bg-light d-flex flex-fill">
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="row">
                                            ...
                                            <div class="col-5 text-center"> <img src="dist/img/user2-160x160.jpg" alt="user-avatar" class="img-circle img-fluid"> </div>
                                        </div>
                                    </div>
                                    <div class="card-footer">
                                        <div class="text-right"> <a href="#" class="btn btn-sm bg-teal"> <i class="fas fa-comments"></i> </a> <a href="#" class="btn btn-sm btn-primary"> <i class="fas fa-user"></i> View Profile </a> </div>
