                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            <div class="small-box bg-gray">
                                ...
                                <div class="icon"> <i class="ion ion-bag"></i> </div> <a href="trustee_official.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-12">
                            <div class="small-box bg-pink">
                                ...
                                <div class="icon"> <i class="ion ion-stats-bars"></i> </div> <a href="trustee_staff.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
            </section> <!-- /.Left col -->
