                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">About us</h5> <button type="button"
                                class="close" data-dismiss="modal" aria-label="Close"> <span
                                    aria-hidden="true">&times;</span> </button>
                        </div>
                        <div class="modal-body">
                            <p align="justify"> This brainchild connected over 300 NGOs from 31 districts in
                                Maharashtra. Now a recognized state organization, MMNF focuses on projects like Minority
                                Development Centre (MDC), Community Development Centre (CDC), and more, empowering NGOs
                                and the community across the state.MMNF is committed to connect and co-relate all NGOS
                                from all corners of the state to empower them & to empower the community at large. MMNF
                                creates a state level federation of Minority NGO’s, as well as create a bunch of expert
                                persons, which called as Knowledge Tank with the help of Knowledge tank, MMNF always
                                trying to give solutions to community in education, health, Industry, business, skills,
                                legal, financial etc. to up-liftment of community in all manner.</p>
                        </div>
                                ...
                                <div class="card-header d-flex p-0">
                                    <ul class="nav nav-pills ml-auto p-2">
                                        <li class="nav-item"><a class="nav-link active" href="#tab_1"
                                                data-toggle="tab">About Department</a></li>
                                        <li class="nav-item"><a class="nav-link" href="#tab_2" data-toggle="tab">Our
                                                Team</a></li>
                                        <li class="nav-item"><a class="nav-link" href="#tab_3"
                                                data-toggle="tab">Achievements and Projects</a></li>
                                        <li class="nav-item"><a class="nav-link" href="#tab_4"
                                                data-toggle="tab">Associates with us</a></li>
                                        <li class="nav-item"><a class="nav-link" href="#tab_5"
                                                data-toggle="tab">Schemes</a></li>
                                        ...
                                        <li class="nav-item"><a class="nav-link" href="#tab_9"
                                                data-toggle="tab">Programs</a></li>
                                                ...
                                                <div class="col-lg-7">
                                                    <div id="carouselExampleIndicators" class="carousel slide"
                                                        ...
                                                        <div class="carousel-inner">
                                                            <div class="carousel-item active">
                                                                <img class="d-block w-100"
                                                                    src="upload/departments/<?php echo $row['department_images1']; ?>"
                                                                    alt="First slide">
                                                            </div>
                                                            <!-- <div class="carousel-item">
                                                        ...
                                                        <div class="card-body" style="padding:0">
                                                            <div id="carouselExampleIndicators" class="carousel slide"
                                                                ...
                                                                <div class="carousel-inner">
                                                                    <div class="carousel-item active">
                                                                        <img class="d-block w-100"
                                                                            src="upload/departments/<?php echo $row['department_images2']; ?>"
                                                                            alt="First slide">
                                                                    </div>
                                                                    <!-- <div class="carousel-item">
...
=======
                                                            ...
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    ...
                                                                    <form role="form" method="post"
                                                                        action="departmental_feedback_form.php"
    ...
    <footer class="main-footer"> <span>© 2023-25. All rights reserved MMNF | Designed and build in India by <a
                href="hudastechnologies.com/" target="_blank">Huda's Technologies</a>.</span>
