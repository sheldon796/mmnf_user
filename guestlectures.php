    ...
    <div class="row">
      <div class="col-md-12 col-12">
        ...
        <div class="row">
         ...
         <?php
				$sql = 'SELECT * FROM guest_lecture   ORDER BY id DESC';  
        ...
        <div class="col-md-4">
            <div class="item">
              <div class="thumb-content">
                <div class="date-post"> <a href="#"><?php echo $row['datee'];?></a> </div>
                <div class="thumb-inner"> <?php echo $row['upload'];?>  
              ...
              <div class="down-content"> <a href="#">
                ...
                <ul>
                  <li><span><em>Speaker Name: </em><?php echo $row['speaker'];?></span></li>
                </ul>
        ...
        <?php
          ...
          <div class="col-md-4">
            <div class="item">
              <div class="thumb-content">
                <div class="date-post"> <a href="#">**/**/****</a> </div>
                <div class="thumb-inner">  
                <iframe class="embed-responsive" src="https://www.youtube.com/embed/4KI6AGMBInM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                
                </div>
              </div>
              <div class="down-content"> <a href="#">
                <h4>3 day conference at Dapoli</h4>
                </a>
                <ul>
                  <li><span><em>Speaker Name: </em>****************</span></li>
                </ul>
                <p>Maharashtra Minority NGO Forum 1st 3 day conference at Dapoli with precious guest lecture</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="item">
              <div class="thumb-content">
                <div class="date-post"> <a href="#">**/**/****</a> </div>
                <div class="thumb-inner"><iframe class="embed-responsive" src="https://www.youtube.com/embed/rWBxiVQGwDU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
              </div>
              <div class="down-content"> <a href="#">
                <h4>MPSC Guidance Lecture</h4>
                </a>
                <ul>
                  <li><span><em>Speaker Name: </em>****************</span></li>
                </ul>
                <p>Maharashtra Minority NGO Forum UPSC, MPSC guidance lecture</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="item">
              <div class="thumb-content">
                <div class="date-post"> <a href="#">25 Aug</a> </div>
                <div class="thumb-inner"><iframe class="embed-responsive" src="https://www.youtube.com/embed/J6Pm_SBPmrc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
              </div>
              <div class="down-content"> <a href="#">
                <h4>Session</h4>
                </a>
                <ul>
                  <li><span><em>Speaker Name: </em>Dr. Inamdar, Captain Shafi</span></li>
                </ul>
                <p>MMNF- August 25, Session of Dr. Inamdar, Captain Shafi</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="item">
              <div class="thumb-content">
                <div class="date-post"> <a href="#">**/**/****</a> </div>
                <div class="thumb-inner"><iframe class="embed-responsive" src="https://www.youtube.com/embed/DRr-0kUXBuQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
              </div>
              <div class="down-content"> <a href="#">
                <h4>3 day conference</h4>
                </a>
                <ul>
                  <li><span><em>Speaker Name: </em>****************</span></li>
                </ul>
                <p>Maharashtra Minority NGO Forum 1st 3 day conference felicitation programme.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="item">
              <div class="thumb-content">
                <div class="date-post"> <a href="#">**/**/****</a> </div>
                <div class="thumb-inner"><iframe class="embed-responsive" src="https://www.youtube.com/embed/xpGMZN2tYu8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
              </div>
              <div class="down-content"> <a href="#">
                <h4>Conference</h4>
                </a>
                ...
                <p>Maharashtra Minority NGO Forum 1st conference- A.Gani Shaikh and Prof. Hasan Mulani best lecture</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="item">
              <div class="thumb-content">
                <div class="date-post"> <a href="#">**/**/****</a> </div>
                <div class="thumb-inner"><iframe class="embed-responsive" src="https://www.youtube.com/embed/Wh91UqyvsLA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
              </div>
              <div class="down-content"> <a href="#">
                <h4>Conference at Dapoli</h4>
                </a>
                <ul>
                  <li><span><em>Speaker Name: </em>****************</span></li>
                </ul>
                <p>Maharashtra Minority NGO Forum Conference at Dapoli</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="item">
              <div class="thumb-content">
                <div class="date-post"> <a href="#">**/**/****</a> </div>
                <div class="thumb-inner"> <iframe class="embed-responsive" src="https://www.youtube.com/embed/T1Yx6ZYZsOY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> </div>
              </div>
              <div class="down-content"> <a href="#">
                <h4>1st 3 day-Mehbub Badbade</h4>
                </a>
                <ul>
                  <li><span><em>Speaker Name: </em>Mufti Mujaffar Iqbal Parkar</span></li>
                </ul>
                <p>Maharashtra Minority NGO Forum 1st 3 day-Mehbub Badbade, Mufti Mujaffar Iqbal Parkar</p>
              </div>
            </div>
          </div>
        </div>
