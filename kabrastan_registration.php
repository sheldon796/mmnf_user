        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Kabrastan Trust Registration</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Kabrastan Trust Registration</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                            ...
                            <div class="card card-primary">
                                ...
                                <form role="form" method="post" action="" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label>Name of Kabrastan</label> <input type="text" class="form-control" name="name" id="name" placeholder="Enter Name of Kabrastan" required=""> </div>
                                            </div>
                                            <div class="col-lg-4">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label>Location</label> <input type="text" class="form-control" name="location" id="location" placeholder="Enter Location" required=""> </div>
                                            </div>
                                            <div class="col-lg-4">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label>Mobile No</label> <input type="text" class="form-control" name="phone" id="phone" placeholder="Enter Mobile No" required=""> </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label>Degination of Trustee</label> <input type="text" class="form-control" name="designation" id="designation" placeholder="Enter Degination of Trustee" required=""> </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label>Kabrastan Registration No</label> <input type="text" class="form-control" name="registration" id="registration" placeholder="Enter Kabrastan Registration No" required=""> </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label>Upload Certificate(Only PDF)</label><br> <input type="file" name="upload" value="" class="form-control"> </div>
                                            </div>
                                            <div class="col-md-12" style="padding-top:20px;padding-bottom:20px;overflow-x:auto;"> <label for="">Trustee Information:</label>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label>Property Details</label> <input type="text" class="form-control" name="details" id="details" placeholder="Enter Property Details" required=""> </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label for="">Select Constructon Type</label> <select class="form-control" name="construction" id="construction">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label>Area in Sq.ft</label> <input type="text" class="form-control" name="area" id="area" placeholder="Enter Area in Sq.ft" required=""> </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label>Do you update regular audit ? (YES/NO)</label> <input type="text" class="form-control" name="audit" id="audit" placeholder="If yes then type Yes | If No then type No" required=""> </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label>Do you update kabrastan compliance regularly ? (YES/NO)</label> <input type="text" class="form-control" name="compliance" id="compliance" placeholder="Enter Do you update regular audit ? (YES/NO)" required=""> </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label>If update details are pending then give pending details.</label> <input type="text" class="form-control" name="pending" id="pending" placeholder="Enter Details Here" required=""> </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label>What you Expect from MMNF ?</label> <input type="text" class="form-control" name="expect" id="expect" placeholder="Enter Details Here" required=""> </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label>Do you have trust registration or affiliation with MMNF ? (YES/NO)</label> <input type="text" class="form-control" name="registration" id="registration" placeholder="If yes then type Yes | If No then type No" required=""> </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label>Did you join MMNF ? (YES/NO)</label> <input type="text" class="form-control" name="join" id="join" placeholder="If yes then type Yes | If No then type No" required=""> </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label>If yes, then Upload Registration fee transfer receipt. (only PDF)</label><br> <input type="file" name="upload" value="" class="form-control"> </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label>Is there any building premises authority legal permission issue with your trust ? (YES/NO)</label> <input type="text" class="form-control" name="building" id="building" placeholder="If yes then type Yes | If No then type No" required=""> </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label>Do you want advice from MMNF expert team for the developement of property ? (YES/NO)</label> <input type="text" class="form-control" name="advice" id="advice" placeholder="If yes then type Yes | If No then type No" required=""> </div>
                                            </div>
                                        </div>
                                    </div> <!-- /.card-body -->
