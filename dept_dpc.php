...
<div class="Modern-Slider">
  <!-- Slide 1 -->
  <div class="item">
    <div class="img-fill"> <img src="assets/images/data_dept/data (1).jpg" alt="" class="img-fill">
      <div class="info">
        <div >
          <h5>Department</h5>
  ...
  <!-- Slide 2 -->
  <div class="item">
    <div class="img-fill"> <img src="assets/images/data_dept/data (2).jpg" alt="" class="img-fill">
      <div class="info">
        <div>
          <h5>Department</h5>
          <h3>Data and Planning Centre</h3>
  ...
  <!-- Slide 3 -->
  <div class="item">
    <div class="img-fill"> <img src="assets/images/data_dept/data (3).jpg" alt="" class="img-fill">
      <div class="info">
        <div>
          <h5>Department</h5>
          <h3>Data and Planning Centre</h3>
          ...
          <div class="col-md-6">
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/goals.jpg" class="img-fill">
              <div class="text-content" align="justify">
                <h6>Goals</h6>
                <ul style="padding-left: 5px;">
                  <li>To increase Percentage of higher education, financial strength, good health as well as improve living Status.</li>
        ...
        <div class="col-md-8">
          <div class="service-item wow fadeIn" data-wow-duration="0.75s">
            <div class="text-content">
              ...
              <p>Mr. Salim Patekeri is a B.tech Mechanical Engineer they completed their education from Pune. He worked for 10/12 years out of India as a Project Manager in Infrastructure development.Even he was a Chief Engineer in renowed Organization Currently. He is now President of Alkhadin foundation ,lokhseva Social foundation & Founder Secretary of Maharashtra Minority NGO forum(MMNF).</p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="service-item wow fadeIn" data-wow-duration="0.75s">
            <div class="text-content"> <img src="assets/images/DPC/Salim Patekeri.jpg" class="img-fill">
              <h6 align="center">Mr. Salim Patekeri</h6>
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                <div class="text-content">
                  <h6 align="center">Salam Ahmed</h6>
            ...
            <div class="col-md-3">
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                <div class="text-content">
                  <h6 align="center">Dr. Mohsin Shaikh </h6>
                  <p align="center">Associate Director</p>
                </div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                <div class="text-content">
                  <h6 align="center">Mo.Khalid Raza</h6>
                  <p align="center">Associate Director</p>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-3">
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                <div class="text-content">
                  <h6 align="center">Habib Shaikh </h6>
                  <p align="center">Associate Director</p>
                </div>
              </div>
            </div>
