...
{  
	...
	echo $sql="INSERT INTO `dept_inq_cdc`(`name`, `email`, `subject`, `message`) VALUES ('$name','$email','$subject','$message')";
...
<script> 
        	...
        	window.location.href="dept_cdc.php";
...
<div class="Modern-Slider">
  ...
  <div class="item">
    ...
    <div class="img-fill"> <img src="assets/images/MDC_dept/community_development.jpg" alt="" class="img-fill">
      ...
      <div class="info">
        ...
        <div >
          ...
          <h3 style="color: yellow;">Community Development Centre <em>(CDC)</em></h3>
    ...
    <div class="recent-car-content">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="car-details" align="justify">

            <h4>About CDC Department</h4>

            <p align="justify">CDC is a Mohalla-level service center connecting with the nearest MDC.
              <li>CDC is a Mohalla-level service center connecting with the nearest MDC.</li>
              <li>Developed and work as like “Al-Masjid an-Nabawi"</li>
              <li>Developed as goods delivery center of Mera Bazaar Online Grocery Centre,  Bilasudi Centre, Study Centre, 
                  E-learning Centre, Library.</li>
              <li>Getting all information and correspondence to all missions of MMNF.</li>
              <li>Available trained Admin, Emam, and Moajjin to help and guide the community.</li>
              <li>Take a Survey of each home in Mohalla.</li>	
            
            </p>

            <!-- <p align="justify">Community Development Centre (CDC), which represents Masjid/Mohalla area. CDC is connected to nearby MDC and Data planning centre. In CDC we survey door to door to analyse problems and demand of each family. Using this data, we will give SMS or whatsapp notifications to family head and request to connect MDC nearby to utilize further services. CDC is permitted  masjid trust or NGO within area.</p> -->
            ...
            <div class="container">
              ...
              <div class="row">
                ...
                <ul class="car-info col-md-6">
                  ...
                  <li><i class="flaticon"><img src="images/icons/dept_mdc/8.png"></i> <small>Girls Students</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/dept_mdc/3.png"></i> <small>Boys Students</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/dept_mdc/5.png"></i> <small>BPL No </small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/dept_mdc/7.png"></i> <small>APL No</small>

                    <!-- <p>5000</p> -->

                  </li>
                  <li><i class="flaticon"><img src="images/icons/dept_mdc/7.png"></i> <small>No Of CDC</small>
                ...
                <ul class="car-info col-md-6">
                  ...
                  <li><i class="flaticon"><img src="images/icons/dept_mdc/2.png"></i> <small>Own Residency</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/dept_mdc/12.png"></i> <small>Rented Residency</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/dept_mdc/6.png"></i> <small>Beneficiaries No</small>:

                    <!-- <p>500</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/dept_mdc/8.png"></i> <small>Graduate Students</small>:

                    <!-- <p>5000</p> -->

                  </li>
                  <li><i class="flaticon"><img src="images/icons/dept_mdc/8.png"></i> <small>Families</small>:
          ...
          <div class="col-md-6" style="margin-top:40px;">
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/vision.jpg" class="img-fill">
              ...
              <div class="text-content"  align="justify">
                ...
                <p>Provide services to do family survey and aware schemes for upliftment of community in all manner education, health, employment, business, human and legal rights.</p>
          ...
          <div class="col-md-6" style="margin-top:40px;">
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/mission.jpg" class="img-fill">
              ...
              <div class="text-content" align="justify">
                ...
                <p>Create a team of 10 social activists under CDC, survey each family within specific area, analysing it and provide necessary services to benefit of each needy student and person.</p>
          ...
          <div class="col-md-6" style="margin-top:40px;">
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/goals.jpg" class="img-fill">
              ...
              <div class="text-content" align="justify">
                ...
                <p>To increase percentage in higher education, APL category, Healthy and wealthy families, beneficiaries of govt. schemes and living standard of each family.</p>
          ...
          <div class="col-md-6" style="margin-top:40px;">
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/objectives.jpg" class="img-fill">
              ...
              <div class="text-content" align="justify">
                ...
                <p>To create number of CDC. Each Masjid/Mohalla and do active more social activists with regularise there NGO’S. Make a various programmes /schemes as need of individuals.</p>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="service-item wow fadeIn" data-wow-duration="0.75s">
            ...
            <div class="text-content">
              ...
              <p>This Text Will Be Change -> Mr. Abdulgani Shaikh is working as Mission Director for Mission CDC, He is Master in Commerce ,He is 46 years old. He is Manager at Income tax department of Savda group of Companies,a well known Industrial Organizor based at Nashik. He is also Trustee of Masjid a Haran , at Khodenagar,Nashik & NGO namely Faizane Aulia,Nashik.He is the first in MMNF, who began Community Development Center,Masjids Haram, Nashik. Also He is working as trustee in MMNF.</p>
        ...
        <div class="col-md-4">
          ...
          <div class="service-item wow fadeIn" data-wow-duration="0.75s">
            ...
            <div class="text-content"> <img src="assets/images/testimonial/Shamsuddin_Shaikh.jpg" class="img-fill">

              <h6  align="center">Shamsuddin Shaikh (khopoli) </h6>

              <p  align="center">Mission Mentor</p>
              <p  align="center">+91 91721 43782</p>
        ...
        <div class="col-md-4">
          ...
          <div class="service-item wow fadeIn" data-wow-duration="0.75s">
            ...
            <div class="text-content"> <img src="assets/images/testimonial/Shahidbhai.jpg" class="img-fill">

              <h6  align="center">Shahidbhai shaikh <br>(Pune) </h6>

              <p  align="center">Mission President</p>
              <p  align="center">+91 9822414911</p>
        ...
        <div class="col-md-12">
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/arif_Qureshi.jpg" class="img-fill">

                <div class="text-content" align="center">

                  <h6 align="center">Arif Qureshi <br>(Panvel)</h6>

                  <p align="center">Director</p>

                  <small>+91 9324431241</small> </div>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/trustee/abdul_gani.jpg" class="img-fill">

                <div class="text-content" align="center">

                  <h6 align="center">Abdulgani Shaikh <br>(Nashik)</h6>

                  <p align="center"> Director</p>

                  <small>+91 9922401119</small> </div>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                ...
                <div class="text-content" align="center">
                  ...
                  <h6 align="center">Yasin Dalvi <br>(Chiplun)</h6>

                  <p align="center">Director</p>

                  <small>+91 98224 88417</small> </div>
            ...
            <!--<div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/testimonials (1).jpg" class="img-fill">
        ...
        <div class="col-md-12">
          ...
          <div class="section-heading">
            ...
            <div class="text-content">
              ...
              <h2><strong>CDC's With Us</strong></h2>
        ...
        <div class="blog-classic-post">
          ...
          <div class="item">
            ...
            <div class="down-content"> <a href="#">
              ...
              <p>If anybody Masjid /NGO trust interested to register as CDC. Please click Registration as CDC for new registration of CDC.</p>

              <div class="text-button"> <a href="#">Registor Now <i class="fa fa-arrow-right"></i></a> </div>
