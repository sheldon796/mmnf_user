...
{  
	...
	echo $sql="INSERT INTO `dept_inq_sdf`(`name`, `email`, `subject`, `message`) VALUES ('$name','$email','$subject','$message')";
...
<script> 
        	...
        	window.location.href="dept_sdf.php";
...
<div class="Modern-Slider">
  ...
  <div class="item">
    ...
    <div class="img-fill"> <img src="assets/images/MDC_dept/skill_Development.jpg" alt="" class="img-fill">
      ...
      <div class="info">
        ...
        <div >
          ...
          <h3 style="color:yellow;">Skill Developement Forum (Hunnar)</h3>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="car-details">
            ...
            <h4>About Hunnar Department</h4>

            <span>Activities of Department</span>
            <p>
              <li>Hunnar is a skill development center.</li>
              <li>Find dropouts, jobless youth, and persons.</li>
              <li>Skill development centers applicated to NHDC, NIOS, and Skill universities.</li>
              <li>Activate programs for soft skill development.</li>
              <li>Develop training cum development center and skill university for global standard job and business opportunities.</li>
              
            </p>

            <!-- <p align="justify">This mission is mainly focused for enhance certified arcticians, mechanics, technicians in the minority community who is not taking higher or technical education but he/she is expert in workmanship.

            <p align="justify"> As well as, considering dropout rate, students are not getting admissions or not aware about vocational training institutes, industrial training institutes/skill development academies/Vigya ashram/ skill university and industrial bridge courses. We have to educate technically to each dropout. We have to decrease jobless strength. </p> -->
            ...
            <div class="container">
              ...
              <div class="row">
                ...
                <ul class="car-info col-md-6">
                  ...
                  <li><i class="flaticon"><img src="images/icons/skill_development/dropout.png"> </i> <small>No. of dropout</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/skill_development/Iti_stud.png"></i> <small>No. of ITI Students</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/skill_development/diploma.png"></i> <small>No. of Diploma</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/skill_development/skill_center.png"></i> <small>No. of Skill Centers</small> </li>

                </ul>

                <ul class="car-info col-md-6">

                  <li><i class="flaticon"><img src="images/icons/skill_development/degree_holder.png"></i> <small>Degree Holders</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/skill_development/skill_strenght.png"></i> <small>Skill Strength</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/skill_development/course.png"></i> <small>Type of Courses</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/skill_development/success_rate.png"></i> <small>No Of Skill Center</small>
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/vision.jpg" class="img-fill">
              ...
              <div class="text-content"  align="justify">
                ...
                <ul style="padding-left: 5px;">
                  ...
                  <li>Develop To Skill University.</li>

                  <li> Micro-vocational Institutes.</li>

                  <li>Employment to each Jobless. </li>

                  <li>Build  Microskill academics with Training cum production centres.</li>
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/mission.jpg" class="img-fill">
              ...
              <div class="text-content"  align="justify">
                ...
                <ul style="padding-left: 5px;">
                  ...
                  <li> To make a survey of dropouts.</li>

                  <li>To take awareness camps. </li>

                  <li>To take Jobfairs.</li>

                  <li> To create skill institutes,academies,University. </li>

                  <li>To create Vigyanashrams. </li>

                  <li>To creat Statelevel Training & Placement Forum.</li>
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/goals.jpg" class="img-fill">
              ...
              <div class="text-content"  align="justify">
                ...
                <ul style="padding-left: 5px;">
                  ...
                  <li>To improve Strength of unskilled persons.</li>

                  <li> To make ideal and global level skill institutions. </li>

                  <li>To creat presence in Manufacturing,Trading and Service sector in all sectors.</li>

                  <li> To develop Japanese,Chinease skill Education system. </li>
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/objectives.jpg" class="img-fill">
              ...
              <div class="text-content"  align="justify">
                ...
                <ul style="padding-left: 5px;">
                  ...
                  <li> Basically minority community is majority working in service sector ,so we have to develope there representation in each high demanded business sector. </li>

                  <li> Uplift each jobless person to grow upto self supportive level.</li>
        ...
        <div class="col-md-4">
          ...
          <div class="service-item wow fadeIn" data-wow-duration="0.75s">
            ...
            <div class="text-content"> <img src="assets/images/trustee/no_image.jpg" class="img-fill">
              ...
              <h6 align="center"> Prof.Abdul Majid Ansari (Mumbai) </h6>

              <p align="center">Mission Mentor</p>
              <p align="center">+91 8422060195</p>
        ...
        <div class="col-md-8">
          ...
          <div class="service-item wow fadeIn" data-wow-duration="0.75s">
            ...
            <div class="text-content"  align="justify">
              ...
              <p align="justify">Mr. Jakirhusen Shikalgar belongs to Electronic Engineer Profession. Engaged in Energy Conservation. He is founder President of Maharashtra Minority NGO forum & secretary of Ideal Education & Social Forum ,Karad district Satara.</p>
        ...
        <div class="col-md-12">
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                ...
                <div class="text-content">
                  ...
                  <h6 align="center">Lukman Datar <br>(Dhule) </h6>

                  <p align="center">Director</p>
                  <p align="center">+91 9423289123</p>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                ...
                <div class="text-content">
                  ...
                  <h6 align="center">Shafi Shaikh (Pimpri Chinchwad) </h6>

                  <p align="center">Director</p>
                  <p align="center">+91 9881429261</p>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                ...
                <div class="text-content">
                  ...
                  <h6 align="center">Javed pathan sir (Ahmednagar)</h6>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/Reshma-Shaikh.jpg" class="img-fill">

                <div class="text-content">

                  <h6 align="center">Reshma Shaikh (Lonawala)</h6>

                  <p align="center">Director</p>
                  <p align="center">+91 8796784924</p>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                ...
                <div class="text-content">
                  ...
                  <h6 align="center">Yusuf Shah <br>(Jalgaon)</h6>
        ...
        <div class="col-md-12">
          ...
          <div class="section-heading">
            ...
            <div class="text-content">
              ...
              <h2><strong>SDF With Us</strong></h2>
        ...
        <div class="blog-classic-post">
          ...
          <div class="item">
            ...
            <div class="down-content"> <a href="#">
              ...
              <p> Skill training too much important for our community so Interested NGOs,schools join hands with us to start skill centre and run it.</p>
