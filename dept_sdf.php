  ...
  <div class="item">
    <div class="img-fill"> <img src="http://placehold.it/1920x1080" alt="" class="img-fill">
      <div class="info">
        <div >
          <h5>Department</h5>
          <h3>Skill Developement Forum<em>(SDF)</em></h3>
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="car-details">
            ...
            <div class="container">
              <div class="row">
                ...
                <ul class="car-info col-md-6">
                  <li><i class="flaticon"><img src="images/icons/skill_development/degree_holder.png"></i> <small>lDegree Holders</small>:
                    <p>5000</p>
                  </li>
                  ...
                  <li><i class="flaticon"><img src="images/icons/skill_development/success_rate.png"></i> <small>Success Rate</small>:
                    <p>5000</p>
                  </li>
                </ul>
              </div>
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/vision.jpg" class="img-fill">
              <div class="text-content"  align="justify">
                ...
                <ul style="padding-left: 5px;">
                  <li>To Skill up the University.</li>
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-3">
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                <div class="text-content">
                  <h6 align="center">Husen Ajite</h6>
            ...
            <div class="col-md-3">
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                <div class="text-content">
                  <h6 align="center">Lukman datar</h6>
                  <p align="center">Associate Director</p>
                </div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                <div class="text-content">
                  <h6 align="center">Shakil Jamadar</h6>
                  <p align="center">Associate Director</p>
                </div>
              </div>
            </div>
