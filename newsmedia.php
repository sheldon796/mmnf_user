    ...
    <div class="row">
      <div class="col-md-12 col-12">
        ...
        <div class="row">
         ...
         <?php
				$sql = 'SELECT * FROM news_media  ORDER BY id DESC';  
...
<!--                <div class="date-post">datee </div>
-->                <div class="thumb-inner"> <img src="admin/upload/news_media/<?php echo $row['upload'];?>" alt="">
