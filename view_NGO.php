...
{  
         ...
         $web = $_POST['web'];
         $a_12 = $_POST['a_12'];
		 //$a_12_up = $_POST['a_12_up'];
         $g_80 = $_POST['g_80'];
		// $g_80_up = $_POST['g_80_up'];
         $fcra = $_POST['fcra'];
		 //$fcra_up = $_POST['fcra_up'];
         $csr_1 = $_POST['csr_1'];
		// $csr_1_up = $_POST['csr_1_up'];
         $csr_2 = $_POST['csr_2'];
		// $csr_2_up = $_POST['csr_2_up'];
         $gst = $_POST['gst'];
		// $gst_up = $_POST['gst_up'];
         $msme_reg = $_POST['msme_reg'];
		 //$msme_reg_up = $_POST['msme_reg_up'];
         $dar_reg = $_POST['dar_reg'];
		 //$dar_reg_up = $_POST['dar_reg_up'];
         $f1 = $_POST['f1'];
         $f2 = $_POST['f2'];
         $f3 = $_POST['f3'];
         $f4 = $_POST['f4'];
...
//****************************************************************************************************************************************************		 
		...
		$target_a_12 = "assets/documents/NGOC_CT/"; 
		$target_a_12 = $target_a_12 . basename( $_FILES['a_12_up']['name']);
		 
		//This gets all the other information from the form 
		$a_12_up = ($_FILES['a_12_up']['name']); 
		
		//Writes the photo to the server 
		if (move_uploaded_file($_FILES['a_12_up']['tmp_name'], $target_a_12)) { 
			//Tells you if its all ok 
			echo "The file ". basename( $_FILES['a_12_up']['name']). " has been uploaded, and your information has been added to the directory<br>"; 
		} else { 
...
//****************************************************************************************************************************************************		 
		//This is the directory where images will be saved 
		$g_80 = "assets/documents/NGOC_CT/"; 
		$g_80 = $g_80 . basename( $_FILES['g_80_up']['name']);
		 
		//This gets all the other information from the form 
		$g_80_up = ($_FILES['g_80_up']['name']); 
		
		//Writes the photo to the server 
		if (move_uploaded_file($_FILES['g_80_up']['tmp_name'], $g_80)) { 
			//Tells you if its all ok 
			echo "The file ". basename( $_FILES['g_80_up']['name']). " has been uploaded, and your information has been added to the directory <br>"; 
		} else { 
			//Gives an error if its not 
			echo "Sorry, there was a problem uploading your file.";
		}
