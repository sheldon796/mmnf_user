                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <select class="form-control" name="Castigates" id="Castigates" >
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label for="">Other Castigates</label>
                          <select class="form-control" name="Other_Castigates" id="Other_Castigates">
                            <option value="">--Select--</option>
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <select class="form-control" id="current_class" name="current_class">
                            <option value="">--Select--</option>
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="previous_marks" id="previous_marks" placeholder="Enter Marks" required="">
                        </div>
                      </div>
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label for="">Address</label>
                          <textarea class="form-control" name="Address" id="" rows="3" placeholder="Enter Address" data-lt-tmp-id="lt-867403" spellcheck="false" data-gramm="false" required=""></textarea>
                        </div>
                      </div>
                      <div class="col-lg-4">
                        <div class="form-group">
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label for="">Masjid Chairman Name</label>
                          <input type="text" class="form-control" name="Mashjid_chairman" id="Mashjid_chairman" placeholder="Enter Mashjid Chairman Name" required="">
                        </div>
                      </div>
                      <div class="col-lg-12">
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <input type="radio" name="fruit" value="apple"> Completed                  
                          <input type="radio" name="fruit" value="orange"> Pursuing 
                          <input type="radio" name="fruit" value="orange"> Intrest to learn 
                        </div>
                      </div>                
                      <div class="col-lg-4">
                        <div class="form-group">
                      ...
                      <div class="col-lg-12">
                        <h4 style="color:#9E358A"><b>Do you want to use locker :</b></h4>
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <input type="file" name="fruit" value="apple" class="form-control" disabled>
                        </div>
                      </div>
                      <div class="col-lg-4">
                        <div class="form-group">
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label>Upload Voter Card</label><br>
                          <input type="file" name="fruit" value="apple" class="form-control" disabled>
                        </div>
                      </div>
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label>Upload OBC/EWS</label><br>
                          <input type="file" name="fruit" value="apple" class="form-control" disabled>
                        </div>
                      </div>
                      <div class="col-lg-4">
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label>Upload Ration Card</label><br>
                          <input type="file" name="fruit" value="apple" class="form-control" disabled>
                        </div>
                      </div>
                      <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label>Upload Domicile & Nationality</label><br>
                        <input type="file" name="fruit" value="apple" class="form-control" disabled>
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label>Upload Ayushman Bharat Card</label><br>
                        <input type="file" name="fruit" value="apple" class="form-control" disabled>
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label>Upload E-Shram Card</label><br>
                        <input type="file" name="fruit" value="apple" class="form-control" disabled>
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label>Upload Labour card</label><br>
                        <input type="file" name="fruit" value="apple" class="form-control" disabled>
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label>Upload Accidental Insurance</label><br>
                        <input type="file" name="fruit" value="apple" class="form-control" disabled>
                      </div>
                    </div>            
                  </div>
