                        ...
                        <div class="col-md-4  col-sm-6">
					  	...
					  	<div class="item">
							...
							<div class="down-content">
								...
								<a href="#"><h4>Speech by Professor farhan makba  </h4></a>

								

								<p>Speech by Professor farhan makba  Conference of Maharashtra Miniority NGO Forum At  karimi laibrery , Anjuman Islam C.S.T. mumbai.</p>	
                        ...
                        <div class="col-md-4  col-sm-6">
					  	...
					  	<div class="item">
							...
							<div class="down-content">
								...
								<a href="#"><h4>Speech on wakf property</h4></a>
