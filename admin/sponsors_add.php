...
{ 
	...
	echo $sql="INSERT INTO `sponsors`(`title`, `description`, `upload`, `datee`) VALUES ('$title','$description','$upload','$datee')";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Brilliant Achievers</a>
      </ol>
    </section>
    <!-- Main content -->
