    ...
    <section class="content">
      ...
      <div class="row"> 
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <a href="videogallery_add.php"><span class="info-box-icon bg-green"><i class="fa fa-plus"></i></span></a>
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <thead>
                ...
                <?php
				$sql = 'SELECT * FROM videogallery   ORDER BY id DESC';  
                ...
                <tr>
                  ...
                  <td><a href="upload/videogallery/<?php echo $row['upload'];?>"><img src="upload/videogallery/<?php echo $row['upload'];?>" width="100" height="80"><?php echo $row['upload'];?></a></td>
                  
                  <td><div class="btn-group">
                      
                      <a href="videogallery_edit.php?id=<?php echo $row['id'];?>" class="btn btn-warning"> <span><strong>Edit</strong></span> </a>  
