...
{ 
	...
	echo $sql="INSERT INTO `upcoming_events_achievement`(`title`, `description`, `upload`, `datee`) VALUES ('$title','$description','$upload','$datee')";
	...
	{?>
		<script> 
        	...
        	window.location.href="upcoming_events_achievement.php";
        </script>
	<?php
	}
	else 
