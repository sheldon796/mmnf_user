    ...
    <section class="content">
      ...
      <div class="row"> 
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <a href="testimonial_add.php"><span class="info-box-icon bg-green"><i class="fa fa-plus"></i></span></a>
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <thead>
                ...
                <tr>
                  ...
                  <td><img src="upload/testimonial/<?php echo $row['upload'];?>" width="100" height="80"><?php echo $row['upload'];?></td>
                  
                  <td><div class="btn-group">
                      
                      <a href="events_achievement_edit.php?id=<?php echo $row['id'];?>" class="btn btn-warning"> <span><strong>Edit</strong></span> </a>  
                      <a href="delete.php?tid=<?php echo $id;?>" class="btn btn-danger">  <span><strong>Delete</strong></span> </a>
