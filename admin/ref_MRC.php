              ...
              <table class="table table-hover">
                ...
                while($row = $result->fetch_array()){  ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $row['mdc_reg'];?></td>
                    <td><?php echo $row['ap_name'];?></td>
                    <td><?php echo $row['ap_mobile'];?></td>
                    <td><?php echo $row['ap_designation'];?></td>
                    <td><?php echo $row['w_time'];?></td>
                    <td><?php echo $row['d_name'];?></td>
                    <td><?php echo $row['d_qualification'];?></td>
                    <td><?php echo $row['d_mobile'];?></td>

                   
                    <th><div class="btn-group"><a href="ref_view_MRC.php?id=<?php echo $row['id'];?>" class="btn btn-primary"> <span><strong>View</strong></span> </a> </div></th>
