...
{ 
		$title = $_POST['title'];
		$description = $_POST['description'];$speaker = $_POST['speaker'];
		$upload = $_POST['upload'];
		$datee = $_POST['datee'];
	 ...
	 echo $sql="INSERT INTO `guest_lecture`(`title`, `description`,`speaker`, `upload`, `datee`) VALUES ('$title','$description','speaker','$upload','$datee')";
	...
	{?>
		...
		window.location = 'guest_lecture.php';
...
<title>Add Guest Lectures</title>
        ...
        <div class="box box-primary">
            ...
            <form role="form" method="post" action="" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label>Title</label>
                  <input type="text" class="form-control" placeholder="Enter ..." name="speaker" id="speaker">
                </div>
                <div class="form-group">
                  <label for="exampleInputFile">Upload Youtube link</label>
                  <textarea class="form-control" rows="3" placeholder="Enter ..." name="upload" id="upload"></textarea>
                </div>
                 <div class="form-group">
                  <label>Date</label>
