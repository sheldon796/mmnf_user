      ...
      <div class="col-md-8">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Individual Registration Forms</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <?php
			$id = $_GET['id'];
				$sql = "SELECT * FROM reg_individual WHERE id = '$id'";  
            ...
            <form role="form">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="Name" class="form-control" id="" value="<?php echo $roww['name'];?>">
                </div>
                <div class="form-group">
                  <label for="">Mobile</label>
                  <input type="Mobile" class="form-control" id=""  value="<?php echo $roww['mobile'];?>">
                </div>
                <div class="form-group">
                  <label for="">Email address</label>
                  <input type="email" class="form-control" id="" value="<?php echo $roww['email'];?>">
                </div>
                    <div class="form-group">
                  <label for="">Address</label>
                  <input type="Address" class="form-control" id="" value="<?php echo $roww['address'];?>">
                </div>
                ...
                <div class="col-md-4">
                  ...
                  <select name="qua" id="qua" value="<?php echo $roww['qualification'];?>">
                 ...
                 <div class="col-md-4">
                  ...
                  <input type="Occupation" class="form-control" id="" value="<?php echo $roww['occ'];?>">
                </div>
                </div>
                
                <div class="form-group">
                 <div class="col-md-4">
                  <label for="">Experty</label>
                  <input type="Experty" class="form-control" id="" value="<?php echo $roww['experty'];?>">
                </div>
                </div>
             
                <div class="form-group">
                  <label for="">Social Experiance</label>
                  <input type="Experiance" class="form-control" id="" value="<?php echo $roww['s_experience'];?>">
                </div>
                 ...
                 <div class="col-md-6">
                  ...
                  <div class="input-select">
                  <select name="age" id="age" value="<?php echo $roww['age_group'];?>">
               ...
               <div class="form-group">
                 <div class="col-md-6">
                  ...
                  <div class="input-select">
                  <select name="gender" id="gender" value="<?php echo $roww['gender'];?>">
                ...
                <div class="form-group">
                  <label for="">Reason of joining</label>
                  <input type="Reason" class="form-control" id="" value="<?php echo $roww['r_join'];?>">
                </div>
                </div> 
...
<th>Occupation</th>
<th>Experty</th>
<th>Social Experience</th>
<th>Age Group</th>
<th>Gender</th>
<th>Reason of joining</th>                     
                    <th>Activity</th>
                  </tr>
                </thead>
                <tbody>
                ...
                while($row = $result->fetch_array()){  ?>
                  ...
                  <tr>
                    ...
                    <th><?php echo $row['occ'];?></th>
                    <th><?php echo $row['experty'];?></th>
                    <th><?php echo $row['s_experience'];?></th>
                    <th><?php echo $row['age_group'];?></th>
                    <th><?php echo $row['gender'];?></th>
                                        <th><?php echo $row['r_join'];?></th>
