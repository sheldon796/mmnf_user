    ...
    <section class="content">
      ...
      <div class="row"> 
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <a href="helping_hands_add.php"><span class="info-box-icon bg-green"><i class="fa fa-plus"></i></span></a>
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <thead>
                ...
                <?php
				$sql = 'SELECT * FROM helping_hands   ORDER BY id DESC';  
                ...
                <tr>
                 ...
                 <td><a href="upload/helping_hands/<?php echo $row['upload'];?>"><?php echo $row['upload'];?></a></td>
                  ...
                  <td><div class="btn-group">
                      ...
                      <a href="delete.php?hhid=<?php echo $id;?>" class="btn btn-danger">  <span><strong>Delete</strong></span> </a>
