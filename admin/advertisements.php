    ...
    <section class="content">
      ...
      <div class="row"> 
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <a href="advertisements_add.php"><span class="info-box-icon bg-green"><i class="fa fa-plus"></i></span></a>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">NGO With Us</h3>
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <thead>
                ...
                <tr>
                  ...
                  <td><a href="upload/advertisements/<?php echo $row['upload'];?>"><?php echo $row['upload'];?></a></td>
