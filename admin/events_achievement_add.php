...
{ 
	...
	echo $sql="INSERT INTO `events_achievement`(`title`, `description`, `upload`, `datee`) VALUES ('$title','$description','$upload','$datee')";
	...
	{?>
        ...
        window.location = 'events_achievement.php';</script>
	<?php
	}
	else 
	{?>
            ...
            <form role="form" method="post" action="" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Enter ..." name="upload" id="upload">
                </div>
