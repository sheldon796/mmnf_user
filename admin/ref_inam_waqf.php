            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                <thead>
                  <tr>
                    <th>ID</th> 
                    <th>Name of Enam Waqf </th>
                    <th>Address</th>
                    <th>Authority Person</th>
                    <th>Mobile No</th>
                    <th>Designation of Trustee</th>
                    <th>Enam Waqf Reg No</th> 
                    <th>Activity</th>
                  </tr>
                </thead>
                <tbody>
                  <?php
				$sql = 'SELECT * FROM reg_inam';  
                ...
                while($row = $result->fetch_array()){  ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $row['inam_reg'];?></td>
                    <th><div class="btn-group"><a href="ref_view_inam_waqf.php?id=<?php echo $row['id'];?>" class="btn btn-primary"> <span><strong>View</strong></span> </a> </div></th>
