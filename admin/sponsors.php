    ...
    <section class="content">
      ...
      <div class="row"> 
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <a href="sponsors_add.php"><span class="info-box-icon bg-green"><i class="fa fa-plus"></i></span></a>
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <thead>
                ...
                <tr>
                  ...
                  <td><a href="upload/sponsors/<?php echo $row['upload'];?>"><img src="upload/sponsors/<?php echo $row['upload'];?>" width="100" height="80"><?php echo $row['upload'];?></a></td>
                  
                  <td><div class="btn-group">
                      
                      <!--<a href="sponsors_edit.php?id=<?php echo $row['id'];?>" class="btn btn-warning"> <span><strong>Edit</strong></span> </a> --> 
                      <a href="delete.php?spid=<?php echo $id;?>" class="btn btn-danger">  <span><strong>Delete</strong></span> </a>
