...
include("auth_session.php"); 
		...
		$id = $_GET['id'];
		$sql = "SELECT * FROM photogallery WHERE id = '$id'"; 
...
{ 
	...
	echo $sql="UPDATE `photogallery` SET `title`='$title',`description`='$description',`upload`='$upload',`datee`='$datee' WHERE id=$id";
            ...
            <form role="form" method="post" action="" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" value="<?php echo $row['description'];?>" name="description" id="description"></textarea>
                </div>
                <div class="form-group">
                  <label for="exampleInputFile">File input</label>
                  <input type="file" name="upload" id="upload" value="<?php echo $row['upload'];?>">

                  <p class="help-block">Example block-level help text here.</p>
                </div>
                 <div class="form-group">
                  <label>Date</label>
                  <input type="text" class="form-control"  value="<?php echo $row['datee'];?>" name="datee" id="datee">
                </div>
              </div>
              <!-- /.box-body -->
