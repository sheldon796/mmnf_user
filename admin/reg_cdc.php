            ...
            <div class="box-body table-responsive no-padding">
              ...
              <thead>
                <tr>
                  ...
                  <th>Address</th>
                  <th>A.P Name</th>
                  <th>A.P Designation</th>
                   <th>A.P Education</th>
                  <th>A.P Mobile</th>
                  <th>Member Id</th>
                  <th>Title Of Masjid</th>
                  <th>Waqf Reg. No</th>
                ...
                <tr>
                  ...
                  <td><?php echo $row['ap_designation'];?></td>
                  <td><?php echo $row['ap_education'];?></td>
                  <td><?php echo $row['ap_mobile'];?></td>
                  <td><?php echo $row['member'];?></td>
                  <td><?php echo $row['title'];?></td>
                  <td><?php echo $row['waqf_reg'];?></td>
                  <td><?php echo $row['waqf_upload'];?></td>

                  <td><div class="btn-group">
                      
                      <a href="events_achievement_edit.php?id=<?php echo $row['id'];?>" class="btn btn-warning"> <span><strong>Edit</strong></span> </a>  
                      <a href="delete.php?cid=<?php echo $id;?>" class="btn btn-danger">  <span><strong>Delete</strong></span> </a>
