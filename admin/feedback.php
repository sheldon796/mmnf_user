          ...
          <table class="table table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><div class="btn-group"> <a href="events_achievement_edit.php?id=<?php echo $row['id'];?>" class="btn btn-warning"> <span><strong>Edit</strong></span> </a> <a href="delete.php?fid=<?php echo $id;?>" class="btn btn-danger"> <span><strong>Delete</strong></span> </a> </div></td>
              </tr>
              <?php
				}
				?>
