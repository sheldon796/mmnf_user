...
include("auth_session.php"); 
		...
		$id = $_GET['id'];
		$sql = "SELECT * FROM events_achievement WHERE id = '$id'"; 
...
{ 
	...
	echo $sql="UPDATE `events_achievement` SET `title`='$title',`description`='$description',`upload`='$upload',`datee`='$datee' WHERE id=$id";
...
<title>Events &amp; Acheivements</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Events & Acheivements</a></li>
      </ol>
    </section>
    <!-- Main content -->
      ...
      <div class="row">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Events & Acheivements</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            ...
            <form role="form" method="post" action="" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label>Title</label>
                  <input type="text" class="form-control" placeholder="<?php echo $row['title'];?>" value="<?php echo $row['title'];?>" name="title" id="title">
                </div>
                <div class="form-group">
                  <label>Description</label>
                  <textarea class="form-control" rows="3" placeholder="<?php echo $row['description'];?>" value="<?php echo $row['description'];?>" name="description" id="description"></textarea>
                </div>
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <label>Date</label>
                  <input type="text" class="form-control" placeholder="<?php echo $row['datee'];?>" value="<?php echo $row['datee'];?>" name="datee" id="datee">
                </div>
              </div>
              <!-- /.box-body -->
