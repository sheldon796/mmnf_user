...
<title>Upcomming Events &amp; Acheviments </title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Upcomming Events & Acheviments</a>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      ...
      <div class="row"> 
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <a href="upcoming_events_achievement_add.php"><span class="info-box-icon bg-green"><i class="fa fa-plus"></i></span></a>

            <div class="info-box-content">
              <span class="info-box-text">**********</span>
              <span class="info-box-number">Insert Data</span>
              <span class="info-box-text">**********</span>
            </div>
            <!-- /.info-box-content -->
          </div>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Upcomming Events & Acheviments</h3>
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <thead>
                ...
                <?php
				$sql = 'SELECT * FROM upcoming_events_achievement  ORDER BY id DESC';  
                ...
                <tr>
                  ...
                  <td><a href="upload/upcoming_events/<?php echo $row['upload'];?>"><img src="upload/upcoming_events/<?php echo $row['upload'];?>" width="100" height="80"> </a></td>
                  
                  <td><div class="btn-group">
                      
                      <a href="events_achievement_edit.php?id=<?php echo $row['id'];?>" class="btn btn-warning"> <span><strong>Edit</strong></span> </a>  
                      <a href="delete.php?uid=<?php echo $id;?>" class="btn btn-danger">  <span><strong>Delete</strong></span> </a>
