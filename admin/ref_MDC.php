              ...
              <table class="table table-hover">
                ...
                while($row = $result->fetch_array()){  ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $row['charity_reg'];?></td>
                    <td><?php echo $row['up_certificate'];?></td>
                    <th><?php echo $row['a_name'];?>/th>
                    <th><?php echo $row['designation'];?></th>
                    <th><?php echo $row['m_id'];?></th>
                    <th><?php echo $row['mob_no'];?></th>
                    <th><?php echo $row['e_id'];?></th>

                    <th><div class="btn-group"><a href="ref_view_MDC.php?id=<?php echo $row['id'];?>" class="btn btn-primary"> <span><strong>View</strong></span> </a> </div></th>
