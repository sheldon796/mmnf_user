...
include("auth_session.php"); 
		...
		$id = $_GET['id'];
		$sql = "SELECT * FROM general_notice_board WHERE id = '$id'"; 
...
{ 
	 ...
	 $sql="UPDATE `general_notice_board` SET `title`='$title',`description`='$description',`upload`='$upload',`datee`='$datee' WHERE id=$id";
	...
	if($result)
	{?>
		<script> window.alert("Information Updated")</script>
	<?php
	}
	else 
	{?>
      ...
      <div class="row">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit General Notice Board</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            ...
            <form role="form" method="post" action="" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label>Title</label>
                  <input type="text" class="form-control" placeholder="Enter ..." name="title" id="title" value="<?php echo $row['title'];?>">
                </div>
                <div class="form-group">
                  <label>Description</label>
                  <textarea class="form-control" rows="3" placeholder="<?php echo $row['description'];?>" name="description" id="description" value="<?php echo $row['description'];?>"></textarea>
                </div>
                <div class="form-group">
                  <label for="exampleInputFile">File input</label>
                  <input type="file" name="upload" id="upload" value="upload/DSC_8646.jpg">

                  <p class="help-block"><a href="upload/<?php echo $row['upload'];?>"><?php echo $row['upload'];?></a></p>
                </div>
                 <div class="form-group">
                  <label>Date</label>
                  <input type="text" class="form-control" placeholder="22 Jan 2022" name="datee" id="datee" value="<?php echo $row['datee'];?>">
                </div>
              </div>
              <!-- /.box-body -->
