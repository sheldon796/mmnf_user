  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Result Notice Board</a></li> 
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      ...
      <div class="row"> 
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <a href="result_notice_board_add.php"><span class="info-box-icon bg-green"><i class="fa fa-plus"></i></span></a>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Result Notice Board</h3>
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <thead>
                ...
                <?php
				$sql = 'SELECT * FROM result_notice_board   ORDER BY id DESC';  
                ...
                <tr>
                  ...
                  <td><a href="upload/result_notice_board/<?php echo $row['upload'];?>"><?php echo $row['upload'];?></a></td>
                  
                  <td><div class="btn-group">
                      
                      <a href="events_achievement_edit.php?id=<?php echo $row['id'];?>" class="btn btn-warning"> <span><strong>Edit</strong></span> </a>  
                      <a href="delete.php?rid=<?php echo $id;?>" class="btn btn-danger">  <span><strong>Delete</strong></span> </a>
