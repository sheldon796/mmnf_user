...
{ 
		...
		$target = "upload/exam_notice_board/"; 
	 ...
	 echo $sql="INSERT INTO `exam_notice_board`(`title`, `description`, `upload`, `datee`) VALUES ('$title','$description','$upload','$datee')";
	...
	{?>
		...
		window.location = 'exam_notice_board.php';
