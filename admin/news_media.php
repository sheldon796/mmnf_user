        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">News & Media</h3>
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <thead>
                ...
                <tr>
                  ...
                  <td><img src="upload/news_media/<?php echo $row['upload'];?>" width="100" height="80"><?php echo $row['upload'];?></td>
                  
                  <td><div class="btn-group">
                      
                      <a href="events_achievement_edit.php?id=<?php echo $row['id'];?>" class="btn btn-warning"> <span><strong>Edit</strong></span> </a>  
                      <a href="delete.php?nid=<?php echo $id;?>" class="btn btn-danger">  <span><strong>Delete</strong></span> </a>
