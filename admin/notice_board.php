    ...
    <section class="content">
      ...
      <div class="row"> 
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <a href="notice_board_add.php"><span class="info-box-icon bg-green"><i class="fa fa-plus"></i></span></a>
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <thead>
                ...
                <tr>
                  ...
                  <td><a href="upload/notice_board/<?php echo $row['upload'];?>"><?php echo $row['upload'];?></a></td>
                  
                  
                  
                  <td><div class="btn-group">
                      
                      <!--<a href="general_notice_board_edit.php?id=<?php echo $row['id'];?>" class="btn btn-warning"> <span><strong>Edit</strong></span> </a>  -->
