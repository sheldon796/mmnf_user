          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tbody>
                  <?php
				$sql = 'SELECT * FROM reg_technobuiz';  
                ...
                while($row = $result->fetch_array()){  ?>
                  ...
                  <td><?php echo $row['ap_mobile'];?></td>
                    ...
                    <th><div class="btn-group"><a href="ref_view_technobuiz.php?id=<?php echo $row['id'];?>" class="btn btn-primary"> <span><strong>View</strong></span> </a> </div></th>
