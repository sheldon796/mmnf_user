...
{  
	 ...
	 echo $sql="INSERT INTO `helping_hands`(`amount`, `category`, `name`, `age`, `description`, `upload`, `ngo_name`, `verifier_name`, `datee`) VALUES ('$amount', '$category', '$name', '$age', '$description', '$upload', '$ngo_name', '$verifier_name', '$datee')";
