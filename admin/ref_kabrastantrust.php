              ...
              <table class="table table-hover">
                ...
                while($row = $result->fetch_array()){  ?>
                  ...
                  <tr>
                    ...
                    <th><div class="btn-group"><a href="ref_view_kabrastantrust.php?id=<?php echo $row['id'];?>" class="btn btn-primary"> <span><strong>View</strong></span> </a> </div></th>
