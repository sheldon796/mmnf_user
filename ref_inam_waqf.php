                  ...
                  <div class="search-content">
                    <div class="search-heading">
                      ...
                      <div class="text-content">
                        <h2>Enam Waqf Registration Form</h2>
                      </div>
                    </div>
                    <div class="search-form">
                      <form action="" method="post" role="form"  enctype="multipart/form-data">
                        <div class="row">
                          <div class="col-md-12">
                            <label style="color:#FFFFFF">Name of Enam Waqf </label>
                            <input type="text" onFocus="this.value=''" name="name" id="name" placeholder="Enter the name of Enam Waqf">
                          </div>
                          <div class="col-md-12">
                          ...
                          <div class="col-md-6">
                            ...
                            <input type="text" onFocus="this.value=''" name="ap_degination" id="ap_degination"  placeholder="Degination of Trustee">
                          </div>
                          <div class="col-md-6">
                            <label style="color:#FFFFFF">Enam Waqf Registration No</label>
                            <input type="text" onFocus="this.value=''" name="inam_reg" id="inam_reg" placeholder="inam Waqf Registration No">
                          </div>
                          <div class="col-md-6">
                          ...
                          <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <th scope="row">8</th>
                                <th>Member</th>
                                <td><input type="text" name="tp_name" id="m3_name" placeholder="Name" style="margin-bottom: 0px;"></td>
                          ...
                          <div class="col-md-12">
                            ...
                            <input type="text" onFocus="this.value=''" name="b_detail" id="b_detail" placeholder="Enter Property Details ">
                          </div>
                          <div class="col-md-6">
                          ...
                          <div class="col-md-12">
                            <label style="color:#ffffff;">Do you update inam compliance regularly ? (YES/NO) </label>
                          ...
                          <div class="col-md-12">
                            <label style="color:#ffffff;">Details of land with your trust.</label>
                            <input type="text" onFocus="this.value=''" name="land_details" id="land_details" placeholder="Enter land details">
                          </div>
                          <div class="col-md-12">
