  ...
  <div class="item">
    <div class="img-fill"> <img src="http://placehold.it/1920x1080" alt="" class="img-fill">
      <div class="info">
        <div >
          <h5>Department</h5>
          <h3>Academy for Competitive Exam </h3>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="recent-car-content">
            ...
            <div class="container">
              <div class="row">
                ...
                <ul class="car-info col-md-6">
                  ...
                  <li><i class="flaticon"><img src="images/icons/ace/staff_service.png"></i> <small>Administrative staff service</small> </li>
                  <li><i class="flaticon"><img src="images/icons/ace/mpse_cracked.png"></i> <small>Student cracked UPSE</small>:
                    <p>5000</p>
                  </li>
      ...
      <div class="col-md-12">
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/stor_bg.jpg" class="img-fill">
              <div class="text-content">
                <h6>Objectives</h6>
                <ul style="padding-left: 5px;">
  ...
  <div class="features-search-section">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="service-item wow fadeIn" data-wow-duration="0.75s">
            <div class="text-content"> <img src="assets\images\trustee\1.jpg" class="img-fill">
              <h6 align="center">Mohammed Rafique</h6>
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                <div class="text-content">
                  <h6 align="center">Afsan Sayyad </h6>
            ...
            <div class="col-md-3">
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                <div class="text-content">
                  <h6 align="center">Faruk Naikwade </h6>
                  <p align="center">Associate Director</p>
                </div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                <div class="text-content">
                  <h6 align="center">Jawwad Kazi </h6>
                  <p align="center">Associate Director</p>
                </div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                <div class="text-content">
                  <h6 align="center"> Aslam Shikalgar</h6>
                  <p align="center">Associate Director</p>
                </div>
              </div>
            </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="contact-info">
            ...
            <div class="info-list">
              <ul>
                <li><i class="fa fa-phone"></i><span><a href="tel:+91 8390381731">8390381731</a></span></li>
                <li><i class="fa fa-envelope"></i><span><a href="mailto:mmnf.secaratory@gmail.com">mmnf.secaratory@gmail.com</a></span></li>
