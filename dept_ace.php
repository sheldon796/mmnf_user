...
{  
	...
	echo $sql="INSERT INTO `dept_inq_ace`(`name`, `email`, `subject`, `message`) VALUES ('$name','$email','$subject','$message')";
...
<script> 
        	...
        	window.location.href="dept_ace.php";
...
<div class="Modern-Slider">
  ...
  <div class="item">
    ...
    <div class="img-fill"> <img src="assets/images/MDC_dept/academic_competitive.jpg" alt="" class="img-fill" width="100% !important;">
      ...
      <div class="info">
        ...
        <div >
          ...
          <h3 style="color:yellow;">Academy for Competitive Exam (BRAINAC) </h3>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="car-details">
            ...
            <h4>About Brainiac Department</h4>

            <span>Activities of Department</span>
            <p>
              <li>Brainiac is a department for the development of study centers, libraries, and residential/Non-Residential academics for competitive exams.</li>
              <li>Guide for all competitive exams for KG to PG and for foreign education.</li>
              <li>Coaching via online/offline mode.</li>
              <li>Improve the number of candidates for preparation for competitive exams.</li>
              <li>Activate awareness programs, seminars, and webinars.</li>
              </p>
       

            <!-- <p align="justify">Now a days, at each level of service their is competitions. As well as in Education & govt job sector or Private job sector, there is  full of competition & Entrance Exam  to select merit students/jobseekers. As concern minority community ,there is very less percentage in result of various competitive exam & centre for competitive exam study.</p> -->
            ...
            <div class="container">
              ...
              <div class="row">
                ...
                <ul class="car-info col-md-6">
                  ...
                  <li><i class="flaticon flaticon"><img src="images/icons/ace/study_center.png"></i> <small>Study centres</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/ace/consultation.png"></i> <small>Students who get counselling</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/ace/upse_exam.png"></i> <small>No.of studying for UPSE</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/ace/mpse.png"></i> <small>No.of student studying in MPSC</small>
                ...
                <ul class="car-info col-md-6">
                  ...
                  <li><i class="flaticon"><img src="images/icons/ace/scc.png"></i> <small>No.of student studying S.S.C</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/ace/staff_service.png"></i> <small>Currently Minority Official In Services</small> </li>

                  <li><i class="flaticon"><img src="images/icons/ace/mpse_cracked.png"></i> <small>Student cracked UPSC</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/ace/mpse_cracked.png"></i> <small>Student craked MPSC</small>
        ...
        <div class="row">
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/vision.jpg" class="img-fill">
              ...
              <div class="text-content">
                ...
                <ul style="padding-left: 5px;">
                  ...
                  <li>To create Competitive exam study centre & training facility centre  to improve result of Competitive exams. </li>

                  <li>To create sports complex to improve participation of player in National & International Sport.</li>

                  <li>To create Police/ Military / Navy / Airforce training centre </li>

                  <li>To improve percentage of Minorities in Security Servicer. </li>
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/mission.jpg" class="img-fill">
              ...
              <div class="text-content">
                ...
                <ul style="padding-left: 5px;">
                  ...
                  <li>To Survey all Students , Motivate them & built their ambition.</li>

                  <li>To Counsell them for Security Service in govt.sector</li>

                  <li>To Provide Counselling to Students for govt. administrative officers competitive exam like Staff Slection, Railway, Airforce ,Drdo, MPSC, UPSC etc.</li>

                  <li>To Support Students those who are interested in Competitive exams.</li>
          ...
          <div class="col-md-6"  style="margin-top:30px;">
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/goals.jpg" class="img-fill">
              ...
              <div class="text-content" align="justifyTo improve No. of staff in security services in various govt. department">

                <!-- <h6>Goals</h6> -->

                <ul style="padding-left: 5px;">

                  <li>To improve percentage of Minorities in all government department or administrative staff/officer.</li>

                  <li>To improve number of students who willing to get government jobs.</li>

                  <li> To improve no. of staff in security services in various govt.department </li>
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/objectives.jpg" class="img-fill">
              ...
              <div class="text-content">
                ...
                <ul style="padding-left: 5px;">
                  ...
                  <li>To increase number of govt services officer from minorities, so the effect of goverment schemes will show very positive. </li>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="service-item wow fadeIn" data-wow-duration="0.75s">
            ...
            <div class="text-content">
              ...
              <p> This Text Will Be Change -> Mohammed Rafique have completed Msc.(MED) & is lecturer in biology at K.M Afgarhusain Jr. college Akola. He is president of Brainiac Education Foundation secretary of Ali Public school, Akola & little flower English school, Malkapur district Buldhana .Also Vice President of MMNF.
        ...
        <div class="col-md-4">
          ...
          <div class="service-item wow fadeIn" data-wow-duration="0.75s">
            ...
            <div class="text-content"> <img src="assets/images/testimonial/Sameer-Ahmed.jpg" class="img-fill">

              <h6 align="center">Sameer Ahmed Siddiqui (Delhi)  </h6>

              <p align="center">Mission Mentor</p>
              <p align="center"><p align="center">+91 80558 78692</p></p>
        ...
        <div class="col-md-8">
          ...
          <div class="service-item wow fadeIn" data-wow-duration="0.75s">
            ...
            <div class="text-content">
              ...
              <p>Mohammed Rafique have completed Msc.(MED) & is lecturer in biology at K.M Afgarhusain Jr. college Akola. He is president of Brainiac Education Foundation secretary of Ali Public school, Akola & little flower English school, Malkapur district Buldhana .Also Vice President of MMNF.
        ...
        <div class="col-md-4">
          ...
          <div class="service-item wow fadeIn" data-wow-duration="0.75s">
            ...
            <div class="text-content"> <img src="assets/images/testimonial\Ahsan-Sayyad.jpg" class="img-fill">

              <h6 align="center">Ahsan Sayyad (Jalgaon)</h6>

              <p align="center">Mission President</p>
              <p align="center"><p align="center">+91 8976368581</p></p>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                ...
                <div class="text-content">
                  ...
                  <h6 align="center">Khalid Mirza <br> (Akola)</h6>

                  <p align="center">Director</p>
                  <p align="center">+91 9552957588</p>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                ...
                <div class="text-content">
                  ...
                  <h6 align="center">Aslam Shikalgar (Islampur) </h6>

                  <p align="center">Director</p>
                  <p align="center">+91 9860216536</p>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                ...
                <div class="text-content">
                  ...
                  <h6 align="center">Jawwad Kazi (Pune/Delhi)</h6>

                  <p align="center">Director</p>
                  <p align="center">+91 7269919482</p>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                ...
                <div class="text-content">
                  ...
                  <h6 align="center">Adbul Mulla <br>(Pune)</h6>

                  <p align="center">Director</p>
                  <p align="center">9028783372</p>
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/trustee/1.jpg" class="img-fill">

                <div class="text-content">

                  <h6 align="center">Mo.Rafique Sir <br>(Pune)</h6>

                  <p align="center">Director</p>
                  <p align="center">+91 98227 27254 </p>
        ...
        <div class="col-md-12">
          ...
          <div class="section-heading">
            ...
            <div class="text-content">
              ...
              <h2><strong>ACE With Us</strong></h2>
        ...
        <div class="blog-classic-post">
          ...
          <div class="item">
            ...
            <div class="down-content"> <a href="#">
              ...
              <p>We appeal to NGOs & educational institutions to start online /offline coaching centre for Competative exams.we r providing Related supports..</p>
