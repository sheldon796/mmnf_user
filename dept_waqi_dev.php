      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="car-details">
            ...
            <p>Really waqf means Masjid, Kabrasthan, Enam lands, etc. The waqf properties can do major role in upliftment of community. If we succeed to utilize property, then it will fulfill all required needs of Muslim community as well as other also.But lot of enrichment, illegal sale/possessions, lack of development planning, no income generate from waqf properties.</p>
            <p>In Maharashtra 92000 hector land will be waqf land but nearly 45 land is enriched, no proper monitory & controlling by waqf boar, overruling of waqf mafia. Waqf property is not a useful in current Scenario.</p>
            <p> So, we are trying to train waqf trustees, social leader for proper utilization of waqf properties & support in proper Development forum.</p>
            <div class="container">
              <div class="row">
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/vision.jpg" class="img-fill">
              <div class="text-content">
                ...
                <ul style="padding-left: 5px;">
                  <li>Collect a data of waqf trust.</li>
                  <li> Do google mapping & updating with cental waqf council.</li>
                  <li>Make a online guidance center for each waqf trustes.</li>
                  <li>To make a good revenue plan from waqf properties. </li>
                </ul>
                <br>
              </div>
            </div>
          ...
          <div class="col-md-6">
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/mission.jpg" class="img-fill">
              <div class="text-content">
                <h6>Mission</h6>
                <ul style="padding-left: 5px;">
                  <li>Survey each waqf trust. </li>
                  <li> Make a development plan. </li>
                  <li>Support for documentations. </li>
                  <li> Support for business/Institute of waqf trust to run property.</li>
                  <li> Co-ordination with trust, waqf board, central waqf, council, minority ministry.</li>
                </ul>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/goals.jpg" class="img-fill">
              <div class="text-content">
                <h6>Goals</h6>
                <ul style="padding-left: 5px;">
                  <li> To develop waqf properties to earn more funds for the upliftment of community. </li>
                </ul>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/stor_bg.jpg" class="img-fill">
              <div class="text-content">
                <h6>Objectives</h6>
                <ul style="padding-left: 5px;">
                  <li>To create active, disciplinary waqf management system.</li>
                  <li>To support each & every waqf trust max possible. </li>
                </ul>
              </div>
            </div>
          </div>
  ...
  <div class="features-search-section">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="service-item wow fadeIn" data-wow-duration="0.75s">
            <div class="text-content"> <img src="assets\images\trustee\parvez.jpg" class="img-fill">
              <h6>Adv. Praveez Mahadik</h6>
            </div>
          </div>
        </div>
        <div class="col-md-12">
            ...
            <div class="col-md-3">
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                <div class="text-content">
                  ...
                  <p align="center">Discription about the person and its work</p>
                </div>
              </div>
            </div>
            <div class="col-md-3">
...
{  
	...
	echo $sql="INSERT INTO `dept_inq_waqi_dev`(`name`, `email`, `subject`, `message`) VALUES ('$name','$email','$subject','$message')";
	...
	{?>
        	...
        	window.location.href="dept_waqi_dev.php";
        </script>
            <?php
	}
	else 
