...
<script> 
        	...
        	window.location.href="reg_kabrastantrust.php";
        </script>
<?php
	}
	else 
...
<head>
  ...
  <title>Kabrastan Trust Registration </title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Kabrastan Trust Registration </li>
      </ol>
    </section>
        ...
        <div class="col-md-8">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Kabrastan Trust Registration </h3>
            </div>
           ...
           <form action="" method="post" role="form"  enctype="multipart/form-data">
                        <div class="box-body">
                          <div class="form-group">
                            <label>Name of Kabrastan</label>
                            <input class="form-control"type="text" onFocus="this.value=''" name="name" id="name" placeholder="Enter the name of Kabrastan">
                          </div>
                          <div class="form-group">
                            <label>Address</label>
                          ...
                          <div class="form-group">
                            ...
                            <input class="form-control"type="text" onFocus="this.value=''" name="ap_mobile" id="ap_mobile" placeholder="Enter Mobile No +91 xxxxxxxx88">
                          </div>
                          <div class="form-group">
                            <label>Degination of Trustee</label>
                            <input class="form-control"type="text" onFocus="this.value=''" name="ap_designation" id="ap_designation" placeholder="Enter the Degination of Trustee">
                          </div>
                          <div class="form-group">
                            <label>Kabrastan Registration No</label>
                            <input class="form-control"type="text" onFocus="this.value=''" name="reg_no" id="reg_no" placeholder="Enter Waqf Registration No">
                          </div>
                          <div class="form-group">
                            <label>Upload Certificate<small>(Only PDF)</small></label>
                          ...
                          <div class="form-group">
                            ...
                            <input class="form-control"type="text" onFocus="this.value=''" name="p_detail" id="p_detail" placeholder="Enter Property Details ">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            <label>Do you update kabrastan compliance regularly ? (YES/NO) </label>
                          ...
                          <div class="form-group">
                            ...
                            <input class="form-control"type="text" onFocus="this.value=''" name="aff_reg" id="aff_reg"  placeholder="IF yes then type YES | If no the type NO">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input class="form-control"name="fee_pdf" id="fee_pdf" type="file" class="form-control-file">
                          </div>
                          <div class="form-group">
