...
<title>Data and Planning Centre</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Data Planning Centre</h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Data Planning Centre</a></li>
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile"> <img class="profile-user-img img-responsive img-circle" src="dist/img/logo.png" alt="User profile picture">
              <h3 class="profile-username text-center">DPC</h3>
              <p class="text-muted text-center">Data Planning Centre</p>
              ...
              <div class="row">
                <div class="col-md-12  col-sm-6 col-xs-12"> <a href="#">
                  <div class="info-box bg-aqua" style="border-radius:10px;"> <span class="info-box-icon"><i class="fa fa-user"></i></span>
                    <div class="info-box-content"> <span class="info-box-text">------</span> <span class="info-box-number">Our Network</span>
                      <div class="progress">
                ...
                <div class="col-md-12  col-sm-6 col-xs-12"> <a href="#">
                  <div class="info-box bg-green" style="border-radius:10px;"> <span class="info-box-icon"><i class="fa fa-users"></i></span>
                    <div class="info-box-content"> <span class="info-box-text">------</span> <span class="info-box-number">Notification</span>
                      <div class="progress">
                        <div class="progress-bar" style="width: 100%"></div>
                      </div>
                      <span class="progress-description"><i class="fa fa-arrow-circle-right"></i> Click here for details</span> </div>
                ...
                <div class="col-md-12  col-sm-6 col-xs-12"> <a href="dept_mdc_document_bank.php">
                  <div class="info-box bg-aqua" style="border-radius:10px;"> <span class="info-box-icon"><i class="fa fa-file-text"></i></span>
                    <div class="info-box-content"> <span class="info-box-text">------</span> <span class="info-box-number">Document Bank</span>
                      <div class="progress">
                        <div class="progress-bar" style="width: 100%"></div>
                      </div>
                      <span class="progress-description"><i class="fa fa-arrow-circle-right"></i> Click here for details</span> </div>
                ...
                <div class="col-md-12  col-sm-6 col-xs-12"> <a href="dept_mdc_application.php">
                  <div class="info-box bg-green" style="border-radius:10px;"> <span class="info-box-icon"><i class="fa fa-address-card-o"></i></span>
                    <div class="info-box-content"> <span class="info-box-text">------</span> <span class="info-box-number">Applied Schemes Status</span>
                      <div class="progress">
                        <div class="progress-bar" style="width: 100%"></div>
                      </div>
                      <span class="progress-description"><i class="fa fa-arrow-circle-right"></i> Click here for details</span> </div>
                ...
                <div class="col-md-12  col-sm-6 col-xs-12"> <a href="dept_cdc_officemgnt.php">
                  <div class="info-box bg-yellow" style="border-radius:10px;"> <span class="info-box-icon"><i class="fa fa-balance-scale"></i></span>
                    <div class="info-box-content"> <span class="info-box-text">------</span> <span class="info-box-number">Adminstration </span>
                      <div class="progress">
                        <div class="progress-bar" style="width: 100%"></div>
                      </div>
                      <span class="progress-description"> <i class="fa fa-arrow-circle-right"></i> Click here for details</span> </div>
                ...
                <div class="col-md-12  col-sm-6 col-xs-12"> <a href="cdc_donations.php">
                  <div class="info-box bg-yellow" style="border-radius:10px;"> <span class="info-box-icon"><i class="fa fa-balance-scale"></i></span>
                    <div class="info-box-content"> <span class="info-box-text">------</span> <span class="info-box-number">Donate Us </span>
                      <div class="progress">
                        <div class="progress-bar" style="width: 100%"></div>
                      </div>
                      <span class="progress-description"> <i class="fa fa-arrow-circle-right"></i> Click here for details</span> </div>
                      ...
                      <table class="table table-condensed">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><span class="badge bg-red">21-2022</span></td>
                          </tr>
                          <tr>
                            <td>2.</td>
                            <td>Clean database</td>
                            <td><span class="badge bg-yellow">20-2021</span></td>
                          </tr>
                          <tr>
                            <td>3.</td>
                            <td>Cron job running</td>
                            <td><span class="badge bg-light-blue">19-2020</span></td>
                          </tr>
                          <tr>
                            <td>4.</td>
                            <td>Fix and squish bugs</td>
                            <td><span class="badge bg-green">18-2019</span></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
