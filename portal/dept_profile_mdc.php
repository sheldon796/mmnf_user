...
<title>Minority Development Centre</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Minority Development Centre</h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Department</a></li>
        <li class="active">Minority Development Centre</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-md-4">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile"> <img class="profile-user-img img-responsive img-circle" src="dist/img/logo.png" alt="User profile picture">
              <h3 class="profile-username text-center">MDC</h3>
              <p class="text-muted text-center">Minority Development Centre</p>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="row">
                ...
                <!-- /.col -->
                <div class="col-md-12  col-sm-6 col-xs-12"> <a href="dept_mdc_schemes.php">
                ...
                <!-- /.col -->
                <div class="col-md-12  col-sm-6 col-xs-12"> <a href="dept_mdc_services.php">
                  <div class="info-box bg-red" style="border-radius:10px;"> <span class="info-box-icon"><i class="fa fa-comments-o"></i></span>
                ...
                <div class="col-md-12  col-sm-6 col-xs-12"> <a href="dept_mdc_officemgnt.php">
                  <div class="info-box bg-yellow" style="border-radius:10px;"> <span class="info-box-icon"><i class="fa fa-balance-scale"></i></span>
