...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php
		...
		$marital_status = $individual_reg['marital_status'];	
		$Caste = $individual_reg['Caste'];
		$Disability1 = $individual_reg['Disability1'];
		$Disability2 = $individual_reg['Disability2'];
		$current_occupation = $individual_reg['current_occupation'];
		$Family_Income = $individual_reg['Family_Income'];
		$current_class = $individual_reg['current_class'];
		$previous_clas = $individual_reg['previous_clas'];
		$previous_marks = $individual_reg['previous_marks'];
		$eligible1 = $individual_reg['current_class'];
		$eligible2 = $individual_reg['current_class'];
		$eligible3 = $individual_reg['current_class'];
		$eligible4 = $individual_reg['current_class'];
		$eligible5 = $individual_reg['current_class'];
		$eligible6 = $individual_reg['current_class'];
		$eligible7 = $individual_reg['current_class'];
		$eligible8 = $individual_reg['current_class'];
		$eligible9 = $individual_reg['current_class'];
		$eligible10 = $individual_reg['current_class'];
			
	$catogary = "SELECT * FROM `add_schemes` WHERE castigates='$Disability1' AND id='$id'  AND  marital_status='$marital_status' AND current_occupation='$current_occupation' AND  previous_marks>='$previous_marks' AND  income_limit<='$Family_Income' OR eligible1='$eligible1'  OR eligible2='$eligible2'   OR eligible3='$eligible3'  OR eligible4='$eligible5'  OR eligible6='$eligible6' OR eligible7='$eligible7'   OR eligible8='$eligible8'  OR eligible9='$eligible9'  OR eligible10='$eligible10' ";
	  
	  
	  
				$catogary_result=$link->query($catogary); 
				while($row = $catogary_result->fetch_array()){ 	
			 //echo $row['name']."<br>";
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile"> 
              ...
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item"> <i class="fa fa-mobile" aria-hidden="true"></i> <?php echo $individual_reg['Mobile'];?> </li>
                <li class="list-group-item"> <i class="fa fa-whatsapp" aria-hidden="true"></i> <?php echo $individual_reg['whatsno'];?> </li>
                <li class="list-group-item"> <i class="fa fa-envelope" aria-hidden="true"></i> <?php echo $individual_reg['email'];?> </li>
              </ul>
              <a href="tel:<?php echo $individual_reg['Mobile'];?>" class="btn btn-primary btn-block"><b>Call Now</b></a> </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
          <!-- About Me Box -->
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body"> <strong><i class="fa fa-book margin-r-5"></i> Address</strong>
              <p class="text-muted"> <?php echo $individual_reg['Address'];?>, <?php echo $individual_reg['District'];?>, <?php echo $individual_reg['Taluka'];?>, <?php echo $individual_reg['State'];?> </p>
              <hr>
              ...
              <p> <span class="label label-danger">Gender: <?php echo $individual_reg['Gender'];?></span> <span class="label label-success">Age: <?php echo $individual_reg['Age'];?></span> <span class="label label-info">Blood Group: <?php echo $individual_reg['Blood_Group'];?></span> <span class="label label-warning">Caste: <?php echo $individual_reg['Caste'];?></span> <span class="label label-primary">Near By Mashjid: <?php echo $individual_reg['Mashjid'];?></span> </p>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              <div class="active tab-pane" id="activity"><a href="mdc_individual_profile_edit.php?mipid=<?php echo $id;?>">Update Profile</a>
                <div class="box box-primary">
                  <div class="box-header with-border">
                      ...
                      <div class="row">
                        <div class="col-md-8">
                          <div class="form-group">
                            <label>Full Name</label>0
                            <input type="text" class="form-control" name="name" id="name" value="<?php echo $individual_reg['name'];?>" disabled>
                          </div>
                          <div class="form-group">
                            <label>Fathers Name</label>
                            <input type="text" class="form-control" name="fname" id="fname" value="<?php echo $individual_reg['fname'];?>" disabled>
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group">
                            <img src="upload/individual_reg/<?php echo $individual_reg['upload'];?>" width="150" height="200">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            <label>Mobile</label>
                            <input type="text" class="form-control" name="Mobile" id="Mobile" value="<?php echo $individual_reg['Mobile'];?>" disabled>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            <label>WhatsApp Number</label>
                            <input type="text" class="form-control" name="whatsno" id="whatsno"  value="<?php echo $individual_reg['whatsno'];?>" disabled>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="">Email Address</label>
                            <input type="email"  class="form-control" name="email" id="email" value="<?php echo $individual_reg['email'];?>" disabled>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="">Password</label>
                            <input type="password"  class="form-control" name="Password" id="Password"  value="<?php echo $individual_reg['Password'];?>" disabled>
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <option value="<?php echo $individual_reg['Gender'];?>"><?php echo $individual_reg['Gender'];?></option>
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            <label>Age</label>
                            <input type="text"  class="form-control" name="Age" id="Age" value="<?php echo $individual_reg['Age'];?>" disabled>
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <option value="<?php echo $individual_reg['Blood_Group'];?>"><?php echo $individual_reg['Blood_Group'];?></option>
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <select  class="form-control" name="Caste" id="Caste"  disabled>
                            <option value="<?php echo $individual_reg['Caste'];?>"><?php echo $individual_reg['Caste'];?></option>
                        ...
                        <div class="col-md-4">
                  <div class="form-group">
                      <label for="">Catogaties</label>
                      <select  class="form-control" name="Disability1" id="Disability1">
                      <option value="<?php echo $individual_reg['Disability1'];?>"><?php echo $individual_reg['Disability1'];?></option>
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                      <label for="">Other Catogaties</label>
                      <select  class="form-control" name="Disability2" id="Disability2" disabled>
                        <option value="<?php echo $individual_reg['Disability2'];?>"><?php echo $individual_reg['Disability2'];?></option>
                  ...
                  <option value="<?php echo $individual_reg['marital_status'];?>"><?php echo $individual_reg['marital_status'];?></option>
                  ...
                  <label> Current Occupation </label>
                          <select  class="form-control" name="current_occupation" id="current_occupation" disabled>
                          <option value="<?php echo $individual_reg['current_occupation'];?>"><?php echo $individual_reg['current_occupation'];?></option>
                  ...
                  <div class="col-md-4">
                   <div class="form-group">
                   <label> Anual family income </label>
                          <select  class="form-control" name="Family_Income" id="Family_Income" disabled>
                          <option value="<?php echo $individual_reg['Family_Income'];?>"><?php echo $individual_reg['Family_Income'];?></option>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <select class="form-control" id="current_class" name="current_class" disabled>
                            <option value="<?php echo $individual_reg['current_class'];?>"><?php echo $individual_reg['current_class'];?></option>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <select class="form-control" id="previous_class" name="previous_class" disabled>
                            <option value="<?php echo $individual_reg['previous_class'];?>"><?php echo $individual_reg['previous_class'];?></option>
                            <option value="Class 1">Class 1</option>
                            <option value="Class 2">Class 2</option>
                            <option value="Class 3">Class 3</option>
                            <option value="Class 4">Class 4</option>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text"  class="form-control" name="previous_marks" id="previous_marks" placeholder="Marks" value="<?php echo $individual_reg['previous_marks'];?>" disabled>
                        </div>
                      </div> 
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <textarea  class="form-control" name="Address" id="" rows="3" placeholder="<?php echo $individual_reg['Address'];?>" data-lt-tmp-id="lt-867403" spellcheck="false" data-gramm="false" disabled></textarea>
                          </div>
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                <input type="text"  class="form-control" name="District" id="District" value="<?php echo $individual_reg['District'];?>" disabled>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                                <input type="text"  class="form-control" name="Taluka" id="Taluka" value="<?php echo $individual_reg['Taluka'];?>" disabled>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                                <input type="text"  class="form-control" name="State" id="State" value="<?php echo $individual_reg['State'];?>" disabled>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                                <input type="text"  class="form-control" name="PIN" id="PIN" value="<?php echo $individual_reg['PIN'];?>" disabled>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <input type="text"  class="form-control" name="Mashjid" id="Mashjid" value="<?php echo $individual_reg['Mashjid'];?>" disabled>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <!-- /.tab-pane -->
                ...
                <ul class="timeline timeline-inverse">
                 ...
                 <?php
				echo $catogaryy = "SELECT * FROM `add_schemes` WHERE castigates='$Disability1' AND id='$id'  AND  marital_status='$marital_status' AND current_occupation='$current_occupation' AND  previous_marks>='$previous_marks' AND  income_limit<='$Family_Income' OR eligible1='$eligible1'  OR eligible2='$eligible2'   OR eligible3='$eligible3'  OR eligible4='$eligible5'  OR eligible6='$eligible6' OR eligible7='$eligible7'   OR eligible8='$eligible8'  OR eligible9='$eligible9'  OR eligible10='$eligible10' ";
				
				$catogary_result=$link->query($catogaryy); 
				while($row = $catogary_result->fetch_array()){ 	?>
                  <li> <i class="fa fa-envelope bg-blue"></i>
                    <div class="timeline-item"> <span class="time"><i class="fa fa-clock-o"></i> <?php echo $row['dttmm'];?></span>
                      <h3 class="timeline-header"><a href="#"><?php echo $row['name'];?></a> | <?php echo $row['category'];?></h3>
                      <div class="timeline-body"> <?php echo $row['short_description'];?> </div> 
                      <h3 class="timeline-header"> <?php echo $row['service_fees'];?></h3>
                      <div class="timeline-footer"> <a class="btn btn-primary btn-xs" href="dept_mdc_schemes_apply.php">Apply</a> <a class="btn btn-danger btn-xs">Delete</a> </div>
                    </div>
                  </li>
                  <?php }  ?>
                  <!-- END timeline item -->
