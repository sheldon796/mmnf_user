        ...
        <div class="col-xs-12">
         <div class="box">
            ...
            <div class="project-actions" style="padding-left:10px">
              <a class="btn btn-danger" href="government_resolutions_form.php">Add Government Resolutions Details</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
				          $sql = 'SELECT * FROM government_resolutions  ';  
                ...
                <tr>
                  ...
                  <td class="project-actions text-center">
                      <a class="btn btn-danger btn-sm" href="government_resolutions_delete.php?delete=<?php echo $row['id']; ?>"><i class="fa-solid fa-trash"></i>&ensp;Delete</a>
                  </td>
                </tr>
                <?php
                  }
