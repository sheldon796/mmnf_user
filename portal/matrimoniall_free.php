      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <div class="box box-widget widget-user">
            ...
            <div class="widget-user-header bg-black" style="background: url('dist/img/materminoallogo/indiannikahh.png');" class="img-responsive">
              <h3 class="widget-user-username">India Nikah</h3>
              <h5 class="widget-user-desc">https://www.indianikah.com/</h5>
            </div>
              ...
              <div class="row">
                <div class="col-sm-4 border-right">
                  <div class="description-block">
                    ...
                    <span class="description-text">Brides</span>
                  </div>
                  <!-- /.description-block -->
                </div>
                <!-- /.col -->
                <div class="col-sm-4 border-right">
                  <div class="description-block">
                    ...
                    <span class="description-text">Grooms</span>
                  </div>
                  <!-- /.description-block -->
                </div>
                <!-- /.col -->
        ...
        <div class="col-md-4">
          ...
          <div class="box box-widget widget-user">
            <!-- Add the bg color to the header using any of the bg-* classes -->
            <div class="widget-user-header bg-black" style="background: url('dist/img/materminoallogo/faiz.png');" class="img-responsive">
              <h3 class="widget-user-username">Faiz Nikah</h3>
              <h5 class="widget-user-desc">https://www.faiznikah.com/</h5>
            </div>
        ...
        <!-- /.col --><div class="col-md-4">
          ...
          <div class="box box-widget widget-user">
            <!-- Add the bg color to the header using any of the bg-* classes -->
            <div class="widget-user-header bg-black" style="background: url('dist/img/materminoallogo/indiannikahh.png');" class="img-responsive">
              <h3 class="widget-user-username">Dulah Dulhan</h3>
              <h5 class="widget-user-desc">https://www.dulahdulhan.in/</h5>
            </div>
