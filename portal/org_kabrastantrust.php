          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active">><a href="org_kabrastantrust.php"><i class="fa fa-filter"></i> kabrastan Trust</a></li>
                ...
                <li><a href="org_technobuiz.php"><i class="fa fa-filter"></i> Technobuiz</a></li>
