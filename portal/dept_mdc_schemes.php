...
<div class="row"><div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-aqua" style="border-radius:10px;">
            <div class="inner"> <span class="info-box-number">Mera Adhikar
            ...
            <a href="https://meraadhikar.in/" class="small-box-footer">Click Here  <i class="fa fa-arrow-circle-right"></i></a> </div>
        </div>
        <div class="col-lg-4 col-xs-12">
          <!-- small box -->
          <div class="small-box bg-aqua" style="border-radius:10px;">
            <div class="inner"><span class="info-box-number">Buddy 4 Study</span>
              <p>________________________________________________</p>
            </div>
            <div class="icon"> <i class="ion ion-plus-circled"></i> </div>
            <a href="https://www.buddy4study.com/" class="small-box-footer">Click Here  <i class="fa fa-arrow-circle-right"></i></a> </div>
        </div>
        
        <div class="col-lg-4 col-xs-6">
          <!-- small box -->
          <div class="small-box bg-green" style="border-radius:10px;">
            <div class="inner"> <span class="info-box-number">MMNF Search</span>
              <p>________________________________________________</p>
            </div>
            <div class="icon"> <i class="ion ion-plus-circled"></i> </div>
            <a href="dept_mdc_schemes2.php" class="small-box-footer">Click Here  <i class="fa fa-arrow-circle-right"></i></a> </div>
        </div> 
      </div>
