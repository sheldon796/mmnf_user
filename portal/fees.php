...
<body class="fixed hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = 'SELECT * FROM portal_membership_fees  ';
                                        ...
                                        <tr>
                                            ...
                                            <td><button type="button" class="btn btn-primary">View</button>
                                                <button type="button" class="btn btn-primary">Accept</button><button
                                                    type="button" class="btn btn-primary">Reject</button>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2014-2022 <a href="https://hudastechnologies.com">Huda's Technologies</a>.</strong>
            All rights
            reserved.
        </footer>
