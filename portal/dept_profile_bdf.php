...
<title>Business Development Forum</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Business Development Forum</h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Department</a></li>
        <li class="active">Business Development Forum</li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      <div class="row">
        <div class="col-md-4">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile"> <img class="profile-user-img img-responsive img-circle" src="dist/img/logo.png" alt="User profile picture">
              <h3 class="profile-username text-center">BDF</h3>
              <p class="text-muted text-center">Business Development Forum</p>
              ...
              <div class="row">
               ...
               <div class="col-md-12  col-sm-6 col-xs-12"> <a href="#">
                  <div class="info-box bg-aqua" style="border-radius:10px;"> <span class="info-box-icon"><i class="fa fa-user"></i></span>
                    <div class="info-box-content"> <span class="info-box-text">------</span> <span class="info-box-number"> Registration of Tijarat</span>
                      <div class="progress">
                ...
                <div class="col-md-12  col-sm-6 col-xs-12"> <a href="#">
                  <div class="info-box bg-green" style="border-radius:10px;"> <span class="info-box-icon"><i class="fa fa-users"></i></span>
                    <div class="info-box-content"> <span class="info-box-text">------</span> <span class="info-box-number"> Tijarat Chapters</span>
                      <div class="progress">
                        <div class="progress-bar" style="width: 100%"></div>
                      </div>
                      <span class="progress-description"><i class="fa fa-arrow-circle-right"></i> Click here for details</span> </div>
                ...
                <div class="col-md-12  col-sm-6 col-xs-12"> <a href="#">
                  <div class="info-box bg-aqua" style="border-radius:10px;"> <span class="info-box-icon"><i class="fa fa-file-text"></i></span>
                    <div class="info-box-content"> <span class="info-box-text">------</span> <span class="info-box-number"> Co-Operative Societies </span>
                      <div class="progress">
                        <div class="progress-bar" style="width: 100%"></div>
                      </div>
                      <span class="progress-description"><i class="fa fa-arrow-circle-right"></i> Click here for details</span> </div>
                ...
                <div class="col-md-12  col-sm-6 col-xs-12"> <a href="#">
                  <div class="info-box bg-aqua" style="border-radius:10px;"> <span class="info-box-icon"><i class="fa fa-user"></i></span>
                    <div class="info-box-content"> <span class="info-box-text">------</span> <span class="info-box-number"> Mera Bazar</span>
                      <div class="progress">
                        <div class="progress-bar" style="width: 100%"></div>
                      </div>
                      <span class="progress-description"><i class="fa fa-arrow-circle-right"></i> Click here for details</span> </div>
                ...
                <div class="col-md-12  col-sm-6 col-xs-12"> <a href="#">
                  <div class="info-box bg-green" style="border-radius:10px;"> <span class="info-box-icon"><i class="fa fa-address-card-o"></i></span>
                    <div class="info-box-content"> <span class="info-box-text">------</span> <span class="info-box-number"> Applied Status</span>
                      <div class="progress">
                        <div class="progress-bar" style="width: 100%"></div>
                      </div>
                      <span class="progress-description"><i class="fa fa-arrow-circle-right"></i> Click here for details</span> </div>
                ...
                <div class="col-md-12  col-sm-6 col-xs-12"> <a href="#">
                  <div class="info-box bg-yellow" style="border-radius:10px;"> <span class="info-box-icon"><i class="fa fa-balance-scale"></i></span>
                    <div class="info-box-content"> <span class="info-box-text">------</span> <span class="info-box-number"> Hostels </span>
                      <div class="progress">
                        <div class="progress-bar" style="width: 100%"></div>
                      </div>
                      <span class="progress-description"> <i class="fa fa-arrow-circle-right"></i> Click here for details</span> </div>
                ...
                <div class="col-md-12  col-sm-6 col-xs-12"> <a href="#">
                  <div class="info-box bg-yellow" style="border-radius:10px;"> <span class="info-box-icon"><i class="fa fa-balance-scale"></i></span>
                    <div class="info-box-content"> <span class="info-box-text">------</span> <span class="info-box-number"> Jobs</span>
                      <div class="progress">
                        <div class="progress-bar" style="width: 100%"></div>
                      </div>
                      <span class="progress-description"> <i class="fa fa-arrow-circle-right"></i> Click here for details</span> </div>
        ...
        <div class="col-md-8">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Business Development Forum</h3>
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <img src="dist/img/pexels-nappy-936137.jpg" class="img-responsive">
            </div>
            <!-- /.box-body -->
          </div>
