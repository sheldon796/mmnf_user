...
//This is the directory where images will be saved 
	...
	$sql="INSERT INTO `mdc_individual_reg`
	(`name`, `fname`, `upload`, `Mobile`, `whatsno`, `email`, `Password`, `Gender`, `Age`, `Blood_Group`, `Caste`, `Disability1`, `Disability2`,`marital_status`,`current_occupation`,`Family_Income`, `Address`,`current_class`,`previous_class`,`previous_marks`, `District`, `Taluka`, `State`, `PIN`, `Mashjid`) VALUES 
	('$name', '$fname', '$upload', '$Mobile', '$whatsno', '$email', '$Password', '$Gender', '$Age', '$Blood_Group', '$Caste', '$Disability1', '$Disability2', '$marital_status', '$current_occupation', '$Family_Income','$Address','$current_class','$previous_class','$previous_marks','$District', '$Taluka', '$State', '$PIN', '$Mashjid')";
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Individual Beneficiary Registration <small><a href="mdc_individual_view.php">View Registered Details</a></small></h1>
      <ol class="breadcrumb">
            ...
            <div class="box box-primary">
              ...
              <div class="box-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                  <label for="upload">Profile Picure </label>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Mobile</label>
                      <input type="text" class="form-control" name="Mobile" id="Mobile" placeholder="Enter ..." required>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>WhatsApp Number</label>
                      <input type="text" class="form-control" name="whatsno" id="whatsno"  placeholder="Enter ..." required>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>Age</label>
                      <input type="text"  class="form-control" name="Age" id="Age" placeholder="Enter ..." required>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                  ...
                  <div class="col-md-4">
                  <div class="form-group">
                      <label for="">Castigates</label>
                      <select  class="form-control" name="Disability1" id="Disability1" required>
                  ...
                  <div class="col-md-4">
                  <div class="form-group">
                      <label for="">Other Castigates</label>
                      <select  class="form-control" name="Disability2" id="Disability2">
                      	<option value="">--Select--</option>
                  ...
                  <label> Current Occupation </label>
                          <select  class="form-control" name="current_occupation" id="current_occupation" required>
                          <option value="">--Select--</option>
                  ...
                  <div class="col-md-4">
                   ...
                   <label> Anual family income </label>
                          <select  class="form-control" name="Family_Income" id="Family_Income" required>
                          	<option value="">--Select--</option>
                  ...
                  <div class="col-md-4">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <select class="form-control" id="previous_class" name="previous_class" required>
                            <option value="">--Select--</option>
                            <option value="Class 1">Class 1</option>
                            <option value="Class 2">Class 2</option>
                            <option value="Class 3">Class 3</option>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text"  class="form-control" name="previous_marks" id="previous_marks" placeholder="Marks" required>
                        </div>
                      </div> 
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea  class="form-control" name="Address" id="" rows="3" placeholder="Enter ..." data-lt-tmp-id="lt-867403" spellcheck="false" data-gramm="false" required></textarea>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <input type="text"  class="form-control" name="Taluka" id="Taluka" placeholder="Taluka" required>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                        <label for="">State - Domicile</label>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <label>Near By Masjid</label>
                      <input type="text"  class="form-control" name="Mashjid" id="Mashjid" placeholder="Enter Near By Masjid..." required>
                    </div>
                  </div>
                </div>
