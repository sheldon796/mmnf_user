...
//This is the directory where images will be saved 
	...
	echo $sql="INSERT INTO `add_contactperson`(`category`, `name`, `email`, `mobile`, `image`) VALUES ('$category', '$name', '$email', '$mobile', '$image')";
...
<div class="wrapper">
 <?php 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Add Helpline <small>Preview</small></h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Helpline</a></li>
        <li class="active">Add Helpline Numbers</li>
      </ol>
    </section>
        ...
        <!-- general form elements disabled -->
          <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Add Helpline Numbers Form</h3>
            </div>
            <!-- /.box-header -->
            ...
            <div class="box-body"> 
                ...
                <div class="form-group">
                  <label>Email</label>
                  <input type="text" class="form-control" placeholder="Enter ..." name="email" id="email">
                </div>
 
                <div class="form-group">
                  <label>Mobile Number</label>
                  <input type="text" class="form-control" placeholder="Enter Service Fees..." name="mobile" id="mobile">
                </div>
 ...
 <div class="form-group">
                  ...
                  <p class="help-block">400px*400px Only</p>
                </div>
