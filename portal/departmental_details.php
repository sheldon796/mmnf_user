        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="departmental_team.php" method="POST" enctype="multipart/form-data">
                <div class="card-body">
...
if (isset($_POST['submit'])) {
    $department = mysqli_escape_string($link, $_POST['department']);
    $title1 = mysqli_escape_string($link, $_POST['title1']);
    $description1 = mysqli_escape_string($link, $_POST['description1']);
    $vision = mysqli_escape_string($link, $_POST['vision']);
    $mission = mysqli_escape_string($link, $_POST['mission']);
    $goals = mysqli_escape_string($link, $_POST['goals']);
    $objectives = mysqli_escape_string($link, $_POST['objectives']);
    $title2 = mysqli_escape_string($link, $_POST['title2']);
    $description2 = mysqli_escape_string($link, $_POST['description2']);
    $target = mysqli_escape_string($link, "upload/departments/");
