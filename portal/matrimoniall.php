    ...
    <section class="content">
      ...
      <div class="row"><div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-aqua" style="border-radius:10px;">
            <div class="inner"> <span class="info-box-number">Free Websites


</span>
              <p>Free Matchmaking service</p>
            </div>
            <div class="icon"> <i class="ion ion-plus-circled"></i> </div>
            <a href="matrimoniall_free.php" class="small-box-footer">Click Here  <i class="fa fa-arrow-circle-right"></i></a> </div>
        </div>
        <div class="col-lg-4 col-xs-12">
          <!-- small box -->
          <div class="small-box bg-aqua" style="border-radius:10px;">
            <div class="inner"><span class="info-box-number">Paid Websites</span>
              <p>Paid Matchmaking service</p>
            </div>
            <div class="icon"> <i class="ion ion-plus-circled"></i> </div>
            <a href="matrimoniall_paid.php" class="small-box-footer">Click Here  <i class="fa fa-arrow-circle-right"></i></a> </div>
        </div>
        
        <div class="col-lg-4 col-xs-6">
          <!-- small box -->
          <div class="small-box bg-green" style="border-radius:10px;">
            <div class="inner"> <span class="info-box-number">MMNF Matrimonial</span>
              <p>MMNF Matchmaking service</p>
            </div>
            <div class="icon"> <i class="ion ion-plus-circled"></i> </div>
            <a href="matrimoniall_mmnf.php" class="small-box-footer">Click Here  <i class="fa fa-arrow-circle-right"></i></a> </div>
        </div> 
      </div> 
    </section>
    <!-- /.content -->
