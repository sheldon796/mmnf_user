  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">View Registrations</li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
         <div class="box">
            ...
            <div class="project-actions" style="padding-left:10px">
              <a class="btn btn-danger" href="scholarship_form.php">Add Scholarship Details</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th class="text-center" >Eligibility Income</th>
                ...
                <tr>
                  ...
                  <td class="text-center" ><?php echo $row['eligibility_income'];?></td>
                  <td class="text-center" ><?php echo $row['percentage'];?></td>
                  <td class="project-actions text-center">
                      <a class="btn btn-danger btn-sm" href="scholarship_delete.php?delete=<?php echo $row['id']; ?>"><i class="fa-solid fa-trash"></i>&ensp;Delete</a>
                  </td>
                </tr>
                <?php
                  }
