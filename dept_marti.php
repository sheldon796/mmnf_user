  ...
  <div class="item">
    <div class="img-fill"> <img src="http://placehold.it/1920x1080" alt="" class="img-fill">
      <div class="info">
        <div >
          <h5>Department</h5>
          <h3>Minority Affairs Research & training Institute</h3>
        </div>
      </div>
    </div>
  </div>
            ...
            <div class="container">
              <div class="row">
                ...
                <ul class="car-info col-md-6">
                  ...
                  <li><i class="flaticon"><img src="images/icons/marti/issues.png"></i> <small>Issues Raised</small>:
                    <p>6000</p>
                  </li>
                  <li><i class="flaticon"><img src="images/icons/marti/issue _solved.png"></i> <small>Issues Solved</small>:
                    <p>5000</p>
                  </li>
                  <li><i class="flaticon"><img src="images/icons/marti/schemes.png"></i> <small>Schemes launced</small>:
                    <p>5000</p>
                  </li>
                </ul>
              </div>
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                <div class="text-content">
                  <h6 align="center">Adv Nadim Siddiki</h6>
            ...
            <div class="col-md-3">
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                <div class="text-content">
                  <h6 align="center"> A.R.Shekh </h6>
                  <p align="center">Associate Director</p>
                </div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets\images\trustee\hasan.jpg" class="img-fill">
                <div class="text-content">
