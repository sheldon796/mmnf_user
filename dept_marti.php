...
{  
	...
	echo $sql="INSERT INTO `dept_inq_marti`(`name`, `email`, `subject`, `message`) VALUES ('$name','$email','$subject','$message')";
...
<script> 
        	...
        	window.location.href="dept_marti.php";
...
<div class="Modern-Slider">
  ...
  <div class="item">
    ...
    <div class="img-fill"> <img src="assets/images/MDC_dept/marti.jpg" alt="" class="img-fill">
      ...
      <div class="info">
        ...
        <div >
          ...
          <h3 style="color:yellow;">Minority Affairs Research & training Institute (MARTI)</h3>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="car-details">
            ...
            <h4>About MARTI Department</h4>

            <span>Activities of Department</span>
            <p>
              <li>MARTI is a minority affairs research and training institute.</li>
              <li>Create and develop institutes like BARTI, Sarthi, and Maha Jyoti with the help of the government or our own.</li>
              <li>Monitor government minority development departs, evaluate them, and demand proper budget and welfare awareness.</li>
              <li>Monitor prime minister 15 points minority development program and District minister development control committee.</li>
              <li>Raise issues to the minority commission and high court & supreme court.</li>
              <li>Great library of all government circulars and minority development ministry.</li>
              </p>
            

            <!-- <p align="justify">Minority Affairs Research & training Institute (MARTI) is a department which analyse the figures of various sections from data & planning centre. According to the MARTI we will make budgetary planning , innovative schemes to Minority ministry. Also will take continuous follow up to ministry to utilize allocated & available funds for Upliftment.</p> -->
            ...
            <div class="container">
              ...
              <div class="row">
                ...
                <ul class="car-info col-md-6">
                  ...
                  <li><i class="flaticon"><img src="images/icons/marti/budget.png"> </i> <small> Annual budget of Central govt</small>:

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/marti/annualb2.png"></i> <small>Annual budget of State govt</small>:

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/marti/budgetstate.png"></i> <small>Utilized budget of state</small>:

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/marti/budgetstate.png"></i> <small>Utilized budget of centre</small>:
                ...
                <ul class="car-info col-md-6">
                  ...
                  <li><i class="flaticon"><img src="images/icons/marti/letter.png"></i> <small>letters submitted</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/marti/issues.png"></i> <small>Budeget Of MAFDC</small>

                    <!-- <p>6000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/marti/issue _solved.png"></i> <small>Budeget Of Waqf Board</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/marti/schemes.png"></i> <small>Budeget Of Central Waqf Council</small>
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/vision.jpg" class="img-fill">
              ...
              <div class="text-content" align="justify">
                ...
                <ul style="padding-left: 5px;">
                  ...
                  <li>To make a advance, innovative management with research facility.</li>

                  <li>To upgrade schemes with minority ministry as well as schemes of NGO’s.</li>

                  <li>To create Supervisory management system to continuous improving facilities concern with upliftment of community.</li>
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/mission.jpg" class="img-fill">
              ...
              <div class="text-content"  align="justify">
                ...
                <ul style="padding-left: 5px;">
                  ...
                  <li>To develop Managerial Organisational Structure for day to day work & correspondance with NGO’s, MDC, CDC, institutions & government departments. </li>
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/goals.jpg" class="img-fill">
              ...
              <div class="text-content"  align="justify">
                ...
                <ul style="padding-left: 5px;">
                  ...
                  <li>To improve all Statistical data concern to various verticals of Mnority Ministry.</li>

                  <li>To make a better co-ordination in between NGO’s institutions, industries, & government department. </li>
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/objectives.jpg" class="img-fill">
              ...
              <div class="text-content"  align="justify">
                ...
                <ul style="padding-left: 5px;">
                  ...
                  <li>To improve percentage in all verticals of minority upliftment.</li>

                  <li>To improve Knowledge of minoriters Political leaders.</li>

                  <li>To improve relationship between NGO’s & government.</li>
                  <li>Communicate To Government Officials To Resolve Various Issues</li>
                  <li>Increase No Of Minorities In Civil Services</li>
        ...
        <div class="col-md-12">
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/Mohsin-Bhai-Shaikh.jpg" class="img-fill">
                ...
                <div class="text-content">
                  ...
                  <h6 align="center">Mohsin Shaikh (Mumbai) </h6>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                ...
                <div class="text-content">
                  ...
                  <h6 align="center">Jamshed khan (Kalyan) </h6>

                  <p align="center">Director</p>
                  <p align="center">+91 9923107855</p>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                ...
                <div class="text-content">
                  ...
                  <h6 align="center">Firoj Mulla (Pune) </h6>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/Firoj-Shaikh.jpg" class="img-fill">

                <div class="text-content">

                  <h6 align="center">Firoj Shaikh (Nagpur)  </h6>

                  <p align="center"> Director</p>
                  <p align="center">+91 91589 83786</p>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                ...
                <div class="text-content">
                  ...
                  <h6 align="center">Chand hai Balbatti (Pune)  </h6>

                  <p align="center"> Director</p>
                  <p align="center">+91 92263 78101</p>
        ...
        <div class="col-md-12">
          ...
          <div class="section-heading">
            ...
            <div class="text-content">
              ...
              <h2><strong>Marti with us</strong></h2>
        ...
        <div class="blog-classic-post">
          ...
          <div class="item">
            ...
            <div class="down-content"> <a href="#">
              ...
              <p>This Depertment Is Working With All Government Official Interaction
                 To Raise Public Issues, Requirement Of Welfare. Hence We Appeal To All Social Political Religious Leaders And NGO’S, Please Join With Us.   </p>

              </a>

              <p></p>

              <div class="text-button"> <a href="ref_NGO.php">Continue Reading <i class="fa fa-arrow-right"></i></a> </div>
