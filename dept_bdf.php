...
{  
	...
	echo $sql="INSERT INTO `dept_inq_bdf`(`name`, `email`, `subject`, `message`) VALUES ('$name','$email','$subject','$message')";
...
<script> 
        	...
        	window.location.href="dept_bdf.php";
...
<div class="Modern-Slider">
  ...
  <div class="item">
    ...
    <div class="img-fill"> <img src="assets/images/MDC_dept/business_development.jpg" alt="" class="img-fill">
      ...
      <div class="info">
        ...
        <div >
          ...
          <h3 style="color:yellow;" >Business Development Forum (Tijarat)</h3>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="car-details">
            ...
            <h4>About Tjarat Department</h4>

            <span>Activities of Department</span>
            <P>
              <li>Tjarat is a department of business research development and training center.</li>
              <li>Collect data of all businessmen / Tajir from street hawkers to corporate and make a business directory.</li>
              <li>Creates chapters of each city and district-wise.</li>
              <li>Activate conferences, exhibitions, seminars, and webinars.</li>
              <li>Create various category-wise associations.</li>
              <li>Guidance for legal documentation, business registration, business loan and business activities.</li>
              <li>Develop an interest-free financial system.</li>
              <li>Activate e-commerce platforms (Mera Bazaar) for new and second-hand trade.</li>
              <li>To promote and actively run various co-operative societies.</li>
            </p>

            <!-- <p> This mission promotes students to skill & enhancement to get job or to become self-enterprise. This mission will support to all industrial activity up to market linkages. </p>

            <p>This mission educates students to keep proper documentation and taxation knowledge. This mission decreases unemployment percentage.</p> -->
            ...
            <div class="container">
              ...
              <div class="row">
                ...
                <ul class="car-info col-md-6">
                  ...
                  <li><i class="flaticon"><img src="images/icons/business_development/street_hawkwer.png"></i> <small>Street hawkers</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/business_development/msme_units.png"></i> <small>MSME Units</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/business_development/private.png"></i> <small> No of Pvt.ltd</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/business_development/unemployment.png"></i> <small>Unemployed persons</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/business_development/school.png"></i> <small> Business schools/institutions </small>

                  <li><i class="flaticon"><img src="images/icons/business_development/shg.png"></i> <small>No of SHG,s.</small>
                ...
                <ul class="car-info col-md-6">
                  ...
                  <li><i class="flaticon"><img src="images/icons/business_development/cluster.png"> </i> <small>Cluster projects</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/business_development/business_asso.png"> </i> <small>Business Associations</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/business_development/new_enterprise.png"> </i> <small>New enterprise</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"> <img src="images/icons/business_development/sick.png"></i> <small>Sick Units</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/business_development/co-operative_units.png"> </i> <small> Co-operative societies</small>

                    <!-- <p>5000</p> -->

                  </li>
                  <li><i class="flaticon"><img src="images/icons/business_development/co-operative_units.png"> </i> <small> Mera Bazar</small>
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/vision.jpg" class="img-fill">
              ...
              <div class="text-content" align="justify">
                ...
                <ul style="padding-left: 5px;">
                  ...
                  <li>To create state level business platform.</li>

                  <li>To increase No Of Business Profesionals</li>

                  <li> To Train about advance technology for growth of business and to face daily challenges.</li>

                  <li>To empower community with business.</li>
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/mission.jpg" class="img-fill">
              ...
              <div class="text-content"  align="justify">
                ...
                <ul style="padding-left: 5px;">
                  ...
                  <li>To survey all unemployment students, persons.</li>

                  <li>To Facilited skill development Centers.</li>

                  <li>To guide for new business registrations.</li>

                  <li>To create ecommerce facilities as necessary.</li>

                  <li>To create cooperative societies, cluster development schemes, federation of SHG's.</li>
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/goals.jpg" class="img-fill">
              ...
              <div class="text-content"  align="justify">
                ...
                <ul style="padding-left: 5px;">
                  ...
                  <li> To build new 300 enterprise per year.</li>

                  <li>To develop Cooperative consumer stores in each city as retail shoppe chain.</li>

                  <li> To develop Bulk purchase and stockholding companies, cold storage, warehouses, Packaging units, C&F, ecommerce.</li>
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/objectives.jpg" class="img-fill">
              ...
              <div class="text-content"  align="justify">
                ...
                <ul style="padding-left: 5px;">
                  ...
                  <li>To develop social enterprise in each mohalla.</li>

                  <li>To give Halal work to each unemployed.</li>

                  <li>Support to community by means Interest free loans.</li>

                  <li>Campaign For MSMEs Registrations.</li>
        ...
        <div class="col-md-4">
          ...
          <div class="service-item wow fadeIn" data-wow-duration="0.75s">
            ...
            <div class="text-content"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
              ...
              <h6 align="center">Jafar Shaikh Sahab (Jalgaon)</h6>

              <p align="center">Mission Mentor</p>
              <p align="center">+91 94222 79786</p>
         ...
         <div class="col-md-8">
          ...
          <div class="service-item wow fadeIn" data-wow-duration="0.75s">
            ...
            <div class="text-content">
              ...
              <p align="justify">Mr. Jakirhusan Shikalgar belongs to Electronic Engineer Profession. Engaged in Energy Conservation. He is founder President of Maharashtra Minority NGO forum & secretary of Ideal Education & Social Forum ,Karad district Satara.</p>
        ...
        <div class="col-md-4">
          ...
          <div class="service-item wow fadeIn" data-wow-duration="0.75s">
            ...
            <div class="text-content"> <img src="assets/images/trustee/Jakir Shikalgar.jpg" class="img-fill">
              ...
              <h6 align="center">Mr.Jakir Shikalgar</h6>
        ...
        <div class="col-md-12">
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/Salim-Shaikh.jpg" class="img-fill">

                <div class="text-content">

                  <h6 align="center">Salim Shaikh <br>(Pune)</h6>

                  <p align="center">Director</p>
                  <p align="center">+91 9371019713</p>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                ...
                <div class="text-content">
                  ...
                  <h6 align="center">Yaseen Shaikh <br>(Solapur) </h6>

                  <p align="center">Director</p>
                  <p align="center">+91 8600480074</p>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/Munnabhai-karbhari.jpg" class="img-fill">

                <div class="text-content">

                  <h6 align="center">Munnabhai karbhari (Solapur) </h6>

                  <p align="center">Director</p>
                  <p align="center">+91 9552278899</p>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                ...
                <div class="text-content">
                  ...
                  <h6 align="center">Yusuf Shah </h6>

                  <p align="center">Director</p>
                  <p align="center">+91 9372575143</p>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                ...
                <div class="text-content">
                  ...
                  <h6 align="center">Akeel Mujawar <br>(Pimpri Chinchwad )</h6>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/Nashir-shaikh.jpg" class="img-fill">

                <div class="text-content">

                  <h6 align="center">Nashir Shaikh<br>(Mumbra/pune) </h6>

                  <p align="center">Director</p>
                  <p align="center">+91 89760 01281</p>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                ...
                <div class="text-content">
                  ...
                  <h6 align="center">Ashfak lodge <br>(khopoli) </h6>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/Gulamnabi-Shaikh.jpg" class="img-fill">

                <div class="text-content">

                  <h6 align="center">Gulamnabi Shaikh <br>(Pune) </h6>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/Samsher-Beg.jpg" class="img-fill">

                <div class="text-content">

                  <h6 align="center">Samsher Beg <br>(Dhule) </h6>
        ...
        <div class="col-md-12">
          ...
          <div class="section-heading">
            ...
            <div class="text-content">
              ...
              <h2><strong>BDF With Us</strong></h2>
        ...
        <div class="blog-classic-post">
          ...
          <div class="item">
            ...
            <div class="down-content"> <a href="#">
              ...
              <p>Everyone Tajir/businessan and jobless persons may join with us.we will develope & run Tijarat chapters in each city to everyone once in month.Hence kindly join with us.</p>
