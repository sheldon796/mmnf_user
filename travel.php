        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Registration for Travel and Guidance</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Registration for Travel and Guidance</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                                ...
                                <form role="form" method="post" action="" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label for="">Vehicle Type</label> <select class="form-control" name="vehicle" id="vehicle">
                                                        <option value="">--Select--</option>
                                                        <option value="">5 Seater Car</option>
                                                        <option value="">7 Seater Car</option>
                                                        <option value="">14/17 Seater Bus</option>
                                                        <option value="">24 Seater Bus</option>
                                                        <option value="">40 Seater Bus</option>
                                                    </select> </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label for="">Booking Services</label> <select class="form-control" name="booking" id="booking">
                                                        <option value="">--Select--</option>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label for="">Stay Services</label> <select class="form-control" name="stay" id="stay">
                                                        <option value="">--Select--</option>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label for="">Tour Services</label> <select class="form-control" name="tour" id="tour">
                                                        <option value="">--Select--</option>
                                                        <option value="">National / International Tourism</option>
                                                        <option value="">Haj</option>
