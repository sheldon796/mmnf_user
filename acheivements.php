...
<!--								<p><a href="index.php">Homepage</a> / <em> Acheivements</em></p>

-->								<h2>Our <em>Acheivements</em></h2>
			...
			<div class="row">
                    ...
                    <div class="col-md-6 "><div class="item">
							...
							<div class="down-content">
								...
								<ul>
									...
									<li><span><em>Posted on:</em><?php echo $row['dttm'];?></span></li>
                ...
                <div class="col-md-6"><div class="item">
					 		...
					 		<div class="thumb-content">
                                ...
                                <iframe class="embed-responsive" src="https://www.youtube.com/embed/eW4n-Lbz7bc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
							...
							<div class="down-content">
								...
								<a href="#"><h4>Efforts made to solve the problems of minorities and the success they have achieved.</h4></a>
                ...
                <div class="col-md-6"><div class="item">
					 		...
					 		<div class="thumb-content">
								...
								<div class="thumb-inner">
									...
									<iframe class="embed-responsive" src="https://www.youtube.com/embed/CSXDfN-s4AU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
							...
							<div class="down-content">
								...
								<a href="#"><h4>Career in Medical, Paramedical and Pharmacy</h4></a>
                ...
                <div class="col-md-6"><div class="item">
					 		...
					 		<div class="thumb-content">
								...
								<div class="thumb-inner">
									...
									<iframe  class="embed-responsive" src="https://www.youtube.com/embed/ycn58RRqz3M" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
							...
							<div class="down-content">
								...
								<a href="#"><h4>Trust Medical Help</h4></a>
                ...
                <div class="col-md-6"><div class="item">
					 		...
					 		<div class="thumb-content">
								...
								<div class="date-post">
									...
									<a href="#">24 May 2021</a>

								</div>

								<div class="thumb-inner">

									<iframe class="embed-responsive" src="https://www.youtube.com/embed/6Qy3SJnuP7Q" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
							...
							<div class="down-content">
								...
								<a href="#"><h4>Technobiz Educational Research Webinar</h4></a>
								...
								<p>On 24/5/21, the Maharashtra Mynaity NGO Forum that took the Technobiz Educational Research, Gaidens, Development and Training Centre and Sir Einstein Academy, The Janibse of Panchgani, Prof. Ashfaq Khan Sir, 9/10th Student and Paske For The ‎‎Careers Of The Study Webinar‎‎ Aanlanaleen.. You can view and hear this webinar from the links above. Zakir Shikalgar, Founder President, Maharashtra Myna-Riti NGO Forum.8390381731‎
								...
								<div class="car-item">
									...
									<div class="thumb-content">
										...
										<div class="car-banner">
											...
											<a href="single_car.html"></a>

										</div>

										<div class="thumb-inner">

											<a href="single_car.html"><img src="ngo_images/ngo_images2.jpeg" width="370" height="260"alt=""></a>
									...
									<div class="down-content">
										...
										<a href="single_car.html"><h4>Aziz Mulla Sahab</h4></a>

										

										<div class="line-dec"></div>

										<p>Speech by Aziz Mulla Sahab President of Conference Maharashtra Miniority NGO.</p>
								...
								<div class="car-item">
									...
									<div class="thumb-content">
										...
										<div class="thumb-inner">
											...
											<a href="single_car.html"><img src="ngo_images/ngo_images5.jpeg" width="370" height="260" alt=""></a>
									...
									<div class="down-content">
										...
										<a href="single_car.html"><h4>Salim Mulla</h4></a>

										

										<div class="line-dec"></div>

										<p>Speech by Salim Mulla topic of Wakf properties and procedure and how can we benefit the Society.</p>
								...
								<div class="car-item">
									...
									<div class="thumb-content">
										...
										<div class="thumb-inner">
											...
											<a href="single_car.html"><img src="ngo_images/ngo_images8.jpeg" width="370" height="260" alt=""></a>
									...
									<div class="down-content">
										...
										<a href="single_car.html"><h4>Farhan Makba</h4></a>
								...
								<div class="car-item">
									...
									<div class="thumb-content">
										...
										<div class="thumb-inner">
											...
											<a href="single_car.html"><img src="ngo_images/ngo_images11.jpeg" width="370" height="260" alt=""></a>
									...
									<div class="down-content">
										...
										<a href="single_car.html"><h4>Dr Shaikh Abdullah</h4></a>
								...
								<div class="car-item">
									...
									<div class="thumb-content">
										...
										<div class="thumb-inner">
											...
											<a href="single_car.html"><img src="ngo_images/ngo_images12.jpeg" width="370" height="260" alt=""></a>
									...
									<div class="down-content">
										...
										<a href="single_car.html"><h4>Riyaz Pirzade</h4></a>
								...
								<div class="car-item">
									...
									<div class="thumb-content">
										...
										<div class="thumb-inner">
											...
											<a href="single_car.html"><img src="ngo_images/ngo_images25.jpeg" width="370" height="260" alt=""></a>
