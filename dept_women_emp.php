...
{  
	...
	echo $sql="INSERT INTO `dept_inq_women_emp`(`name`, `email`, `subject`, `message`) VALUES ('$name','$email','$subject','$message')";
...
<script> 
        	...
        	window.location.href="dept_women_emp.php";
...
<div class="Modern-Slider">
  ...
  <div class="item">
    ...
    <div class="img-fill"> <img src="assets/images/MDC_dept/woman_empowerment.jpg" alt="" class="img-fill">
      ...
      <div class="info">
        ...
        <div >
          ...
          <h3 style="color:yellow;">Women Empowerment Centre (Fatima)</h3>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="car-details">
            ...
            <h4>About Fatima Department</h4>

            <span>Activities of Department</span>
            <p>
              <li>Fatima is a women empowerment center.</li>
              <li>Develop and activate self-help groups, clusters, and co-operative societies.</li>
              <li>Develop ladies’ hostels and rehabilitation centers.</li>
              <li>Uplift girls and women, educationally and financially.</li>
              <li>Develop a self-defense training center. </li>
              
            </p>

            <!-- <p>In Minorities goa official shows that behind every thousand man’s there is as women. Means that we have 50% population of women's this is big human resource easily available.</p>

            <p>Major cause of Misiura backwardness is lack of education to girl, women. With this mission, we empower girl students/women by providing them skill education, training, entrepreneurship development utilizing government /non-government NGO’s schemes.</p> -->
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/vision.jpg" class="img-fill">
              ...
              <div class="text-content">
                ...
                <ul style="padding-left: 5px;">
                  ...
                  <li>To uplift women by providing academics, skill education. </li>

                  <li>Utilizing all governmental/non-governmental Schemes.</li>

                  <li>To Strengthen economic status. </li>

                  <li>To improve above poverty line ratio. </li>
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/mission.jpg" class="img-fill">
              ...
              <div class="text-content">
                ...
                <ul style="padding-left: 5px;">
                  ...
                  <li>To develop women’s institutions like federation of SHG’s, co-operative societies, industry cluster etc.</li>

                  <li>To Survey women’s strength mohalla wise, education wise, skill wise. </li>

                  <li> To create skill development center specially for women's.</li>

                  <li> To improve educational status via; various sources of education.</li>

                  <li>To educate women aspecially on Health Science. </li>
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/goals.jpg" class="img-fill">
              ...
              <div class="text-content">
                ...
                <ul style ="padding-left: 5px;">
                  ...
                  <li>To achieve target value of various verticals of upliftment like drop-out rate, graduation ratio, employed/unemployed, govt/pvt employment. </li>

                  <li>Establish need base programs useful for upliftment. </li>
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/objectives.jpg" class="img-fill">
              ...
              <div class="text-content">
                ...
                <ul style="padding-left: 5px;">
                  ...
                  <li> Create Mohalla wise women committee, self-help groups,NGO's,training center.</li>
                  <li> Create Cluster Projects With 100% Women’s Perticipation.</li>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <div class="service-item wow fadeIn" data-wow-duration="0.75s">
            ...
            <div class="text-content"> <img src="assets/images/testimonial/no_image.jpg"class="img-fill">
              ...
              <h6  align="center">Zarina Deshmukh (Ambajogai) </h6>

              <p align="center">Mission Mentor</p>
              <p align="center">+91 9665227236</p>
        ...
        <div class="col-md-4">
          ...
          <div class="service-item wow fadeIn" data-wow-duration="0.75s">
            ...
            <div class="text-content"> <img src="assets/images/testimonial/Ruksona-answari.jpg"class="img-fill">

              <h6  align="center">Ruksana Ansari (Kalyan) </h6>

              <p align="center">Mission President</p>
              <p align="center">+91 9221518411</p>
        ...
        <div class="col-md-12">
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                ...
                <div class="text-content">
                  ...
                  <h6 align="center">Raisa Pathan <br> (Panvel)</h6>

                  <p align="center">Director</p>
                  <p align="center">+91 9321366248</p>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                ...
                <div class="text-content">
                  ...
                  <h6 align="center">Halima Qureshi <br> (Kharghar)</h6>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/Farha-khan.jpg" class="img-fill">

                <div class="text-content">

                  <h6 align="center">Farha i.khan pathan (Ambarnath)</h6>

                  <p align="center">Director</p>
                  <p align="center">+91 7977188478</p>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/Moin-Qureshi.jpg" class="img-fill">

                <div class="text-content">

                  <h6 align="center">Moin Qureshi <br>(pune) </h6>

                  <p align="center">Director</p>
                  <p align="center">+91 9834652068</p>
        ...
        <div class="col-md-12">
          ...
          <div class="section-heading">
            ...
            <div class="text-content">
              ...
              <h2><strong>Our Women's Empowerment</strong></h2>
        ...
        <div class="blog-classic-post">
          ...
          <div class="item">
            ...
            <div class="down-content"> <a href="#">
              ...
              <p>Considering economy of each household,there is lot of need to give skill training & empower every women towards self dependent financially.There is most essential work for each NGO.so please join with us</p>
