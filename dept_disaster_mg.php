...
{  
	...
	echo $sql="INSERT INTO `dept_inq_disaster_mg`(`name`, `email`, `subject`, `message`) VALUES ('$name','$email','$subject','$message')";
...
<script> 
        	...
        	window.location.href="dept_disaster_mg.php";
...
<div class="Modern-Slider">
  ...
  <div class="item">
    ...
    <div class="img-fill"> <img src="assets/images/MDC_dept/desesters.jpg" alt="" class="img-fill">
      ...
      <div class="info">
        ...
        <div >
          ...
          <h3 style="color:yellow;">Humanity And Disaster Management Centre (Insaniyat)</h3>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="car-details">
            ...
            <h4>About Insaniyat Department</h4>

            <span>Activities of Department</span>
            <p>
              <li>Insaniyat is a humanity and disaster management center.</li>
              <li>Activate various humanity welfare schemes.</li>
              <li>Conduct awareness programs.</li>
              <li>Develop a disaster management team.</li>
              <li>Create special funds for disaster management.</li>
              <li>Develop environment protection projects.</li>
              <li>Develop beggar less Mohalla's.</li>
              <li>Develop Orphanage and rehabilitation centre. </li>
            </p>

            <!-- <p> During national calamities, disasters, communal riots, the Muslim minority community suffer dangerously there will be lack of knowledge.</p>

            <p>About human rights as a citizen of India, hence government compensation will not reach up to affected people, that time DMC, Disaster management center will provide necessary aid/support to concern person.</p> -->
              ...
              <div class="row">
                ...
                <ul class="car-info col-md-6">
                  ...
                  <li><i class="flaticon flaticon-art"></i>
                    ...
                    <p>Desaster Handled </p>

                  </li>

                  <li><i class="flaticon flaticon-shift"></i>

                    <p>Team Stay Facilities Center</p>
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/vision.jpg" class="img-fill">
              ...
              <div class="text-content">
                ...
                <ul style ="padding-left: 5px;">
                  ...
                  <li>To create an online support system which works 24*7 throughout state & Maharashtra. </li>

                  <li> Support foods, medicine, financial needs for affected familiar.</li>
                  <li>Establish Humanity Service Center In Each City</li>
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/mission.jpg" class="img-fill">
              ...
              <div class="text-content">
                ...
                <ul style ="padding-left: 5px;">
                  ...
                  <li> Visit affected area as earlier with disaster management team with necessary reuse tools, foods, medicine </li>

                  <li> Survey property & make a requirement detail.</li>

                  <li> Co-ordinate, communicate with Ngo's as well as government official.</li>

                  <li> Make a relief center in affected area. </li>
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/goals.jpg" class="img-fill">
              ...
              <div class="text-content">
                ...
                <ul style ="padding-left: 5px;">
                  ...
                  <li>To become a voluntary support system with help of NGO's. </li>

                  <li>To give support to affected people to stand with their self-enterprises. </li>
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/objectives.jpg" class="img-fill">
              ...
              <div class="text-content">
                ...
                <ul style ="padding-left: 5px;">
                  ...
                  <li> At the time of disaster, pre-disaster, there will be variety of requirement comes, that time relief center will provide necessary & suitable service like supply of foods, medicine, utensils, house repair vehicle repairs etc.</li>
        ...
        <div class="col-md-4">
          ...
          <div class="service-item wow fadeIn" data-wow-duration="0.75s">
            ...
            <div class="text-content"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
              ...
              <h6 align="center">Shoeb Shaikh (Nanded)</h6>
      ...
      <div class="col-md-12">
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
              ...
              <div class="text-content">
                ...
                <h6 align="center">Salim Babe Shaikh <br>(Pune) </h6>
          ...
          <div class="col-md-3">
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
              ...
              <div class="text-content">
                ...
                <h6 align="center">Mustafa mujawar <br>(Sangli)  </h6>

                <p align="center">Director</p>
                <p align="center">+91 9021516176</p>
          ...
          <div class="col-md-3">
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/Yuosuf-Mukatin.jpg" class="img-fill">

              <div class="text-content">

                <h6 align="center">Yuosuf Mukatin Aurangabad </h6>

                <p align="center">Director</p>
                <p align="center">+91 9923108484</p>
          ...
          <div class="col-md-3">
            ...
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
              ...
              <div class="text-content">
                ...
                <h6 align="center">Dr. Mujahid Ahmed – Akola </h6>

                <p align="center">Director</p>
                <p align="center">+91 9373606005</p>
        ...
        <div class="blog-classic-post">
          ...
          <div class="item">
            ...
            <div class="down-content"> <a href="#">
              ...
              <p>Due to unbalanced environment ,we observing overview of repeated various types of disaster happened.we may aware community about to Do activities to balance & protect environment.Like this we may have program to What to do before Any disaster condition arise and what to do at the time of disaster as well as what to do after any disaster.we may build support system,trained volunteers,Secured reserve funds and rehabilitation centres,rescue teams,etc..For this noble cause.we appeal to join with us.</p>
