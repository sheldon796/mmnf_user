            ...
            <div class="card">
              <div class="card-header d-flex p-0">
                <ul class="nav nav-pills ml-auto p-2">
                  <li class="nav-item"><a class="nav-link active" href="#tab_1" data-toggle="tab">About Departent</a></li>
                  <li class="nav-item"><a class="nav-link" href="#tab_2" data-toggle="tab">Team</a></li>
                  <li class="nav-item"><a class="nav-link" href="#tab_3" data-toggle="tab">Work & Acheivements</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-4  col-sm-12">
                            ...
                            <div class="small-box bg-info">
                                <div style="margin: 10px; padding-top:10px"> <img src="images/logos/m.png" alt="Third" width="100px" height="100px"> </div>
                                <div class="inner">
                                    <h5>Our Mission</h5>
                                    <p align="justify">Empowerment to NGO’s with state level platform of various sectors for Up-liftment of community in all manner and Work for Rights of Minorities in Educate & train Community via Minority Development Centre & Community development centre.</p>
                        ...
                        <div class="col-lg-4  col-sm-12">
                            ...
                            <div class="small-box bg-success">
                                <div style="margin: 10px; padding-top:10px"> <img src="images/logos/v.png" alt="Third" width="100px" height="100px"> </div>
                                <div class="inner">
                                    <h5>Our Vision</h5>
                                    <p align="justify">Empowerment to NGO’s with state level platform of various sectors for Up-liftment of community in all manner and Work for Rights of Minorities in Educate & train Community via Minority Development Centre & Community development centre.</p>
                                </div> <a href="#" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                        ...
                        <div class="col-lg-4  col-sm-12">
                            ...
                            <div class="small-box bg-danger">
                                <div style="margin: 10px; padding-top:10px"> <img src="images/logos/o.png" alt="Third" width="100px" height="100px"> </div>
                                <div class="inner">
            ...
            <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column">
              <div class="card bg-light d-flex flex-fill">
                ...
                <div class="card-footer">
                  <h2 class="lead"><b>Designation</b></h2>
                </div>
              </div>
            </div>
            <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column">
