        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>WAQF Registration</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">WAQF Registration</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                            ...
                            <div class="card card-primary">
                                ...
                                <form role="form" method="post" action="" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label>Name of Waqf</label> <input type="text" class="form-control" name="name" id="name" placeholder="Enter Name of Waqf" required=""> </div>
                                            </div>
                                            <div class="col-lg-4">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label>State</label> <input type="text" class="form-control" name="state" id="sate" placeholder="Enter State" required=""> </div>
                                            </div>
                                            <div class="col-lg-4">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label>Name of Authority Person</label> <input type="text" class="form-control" name="authority" id="authority" placeholder="Enter Name of Authority Person" required=""> </div>
                                            </div>
                                            <div class="col-lg-4">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group"> <label>Waqf Registration No</label> <input type="text" class="form-control" name="registration" id="registration" placeholder="Enter Waqf Registration No" required=""> </div>
                                            </div>
                                            <div class="col-lg-6">
                                            ...
                                            <div class="col-md-12" style="padding-top:20px;padding-bottom:20px;overflow-x:auto;"> <label for="">WAQF Trustee Information:</label>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label>Enter Building Details</label> <input type="text" class="form-control" name="building" id="building" placeholder="Enter Enter Building Details" required=""> </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label for="">Select Constructon Type</label> <select class="form-control" name="construction" id="construction">
                                                        <option value="">--Select Constructon Type--</option>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label>Do you update Waqf compliance regularly ? (YES/NO)</label> <input type="text" class="form-control" name="compliance" id="compliance" placeholder="If yes then type Yes | If No then type No" required=""> </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label>Do you have trust registration or affiliation with MMNF ? (YES/NO)</label> <input type="text" class="form-control" name="affiliation" id="affiliation" placeholder="If yes then type Yes | If No then type No" required=""> </div>
                                            </div>
                                            <div class="col-lg-4">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label>Is there any building premises authority legal permission issue with your trust ? (YES/NO)</label> <input type="text" class="form-control" name="permission" id="permission" placeholder="If yes then type Yes | If No then type No" required=""> </div>
                                            </div>
                                            <div class="col-lg-4">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group"> <label>If yes then Upload Registration fee transfer receipt. (only PDF)</label><br> <input type="file" name="receipt" value="" class="form-control"> </div>
                                            </div>
                                        </div>
                                    </div> <!-- /.card-body -->
