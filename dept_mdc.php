...
<div class="Modern-Slider">
  <!-- Slide 1 -->
  <div class="item">
    <div class="img-fill"> <img src="assets/images/MDC_dept/dept_ban_mdc (1).jpg" alt="" class="img-fill">
      <div class="info">
        <div>
          <h5>Departments</h5>
  ...
  <!-- Slide 2 -->
  <div class="item">
    <div class="img-fill"> <img src="assets/images/MDC_dept/dept_ban_mdc (2).jpg" alt="" class="img-fill">
      <div class="info">
        <div>
          <h5>Department</h5>
          <h3>Minority Development Centre <em>(MDC)</em></h3>
  ...
  <!-- Slide 3 -->
  <div class="item">
    <div class="img-fill"> <img src="assets/images/MDC_dept/dept_ban_mdc (3).jpg" alt="" class="img-fill">
      <div class="info">
        <div>
          <h5>Department</h5>
          <h3>Minority Development Centre <em>(MDC)</em></h3>
          ...
          <div class="col-md-6">
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/goals.jpg" class="img-fill">
              <div class="text-content" align="justify">
                <h6>Goals</h6>
                <ul style="padding-left: 5px;">
                  <li>To build max benefit to community & improve level of upliftment at various sectors.</li>
                  <li>To get data of community Mohall wise/Place wise/Taluka wise.</li>
          ...
          <div class="col-md-6">
            <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/objectives.jpg" class="img-fill">
              <div class="text-content" align="justify">
                <h6>Objectives </h6>
                <ul style="padding-left: 5px;">
                  <li>To creat number of MDC, CDC to do active more social activities & more NGO’s.</li>
                  <li>Make a programmer for Individuals, CDC, NGO’s, Madrasa, Educational institutions.</li>
                  <li>To create Organization Structure to link all institutes within taluka.</li>
                  <li>To do family wise Survey, assessment of needs & comply them.</li>
            ...
            <div class="col-md-3">
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                <div class="text-content" align="center">
                  ...
                  <p align="center">Associate Director</p>
                  <small>+91 8862013933</small> </div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/MDC/shoeb.jpg" class="img-fill">
                <div class="text-content" align="center">
                  <h6 align="center">Shoeb Momin </h6>
                  <p align="center">Associate Director</p>
                  <small>+91 7558555574</small> </div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="contact-info">
            ...
            <div class="info-list">
              <ul>
                <li><i class="fa fa-phone"></i><span><a href="tel:+91 9850757898">9850757898</a></span></li>
                <li><i class="fa fa-envelope"></i><span><a href="mailto:mmnf.secaratory@gmail.com">mmnf.secaratory@gmail.com</a></span></li>
                <li><i class="fa fa-map-marker"></i><span>C4 / 404, Bramha Avenue, Kondhwa, Pune, M.S., India</span></li>
              </ul>
            </div>
          </div>
        </div>
