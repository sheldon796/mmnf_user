...
<head>
    ...
    <title>Recover Password</title> <!-- Google Font: Source Sans Pro -->
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form action="login.html" method="post">
                    ...
                    <div class="row">
                        <div class="col-12"> <button type="submit" class="btn btn-primary btn-block">Change password</button> </div> <!-- /.col -->
                    </div>
                </form>
                <p class="mt-3 mb-1"> <a href="login.html">Login</a> </p>
            </div> <!-- /.login-card-body -->
        </div>
    </div> <!-- /.login-box -->
    <!-- jQuery -->
