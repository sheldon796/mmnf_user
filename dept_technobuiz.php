  ...
  <div class="item">
    <div class="img-fill"> <img src="http://placehold.it/1920x1080" alt="" class="img-fill">
      <div class="info">
        <div >
          <h5>Department</h5>
          <h3>Technobuiz-Business School</h3>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="col-md-6">
          <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/stor_bg.jpg" class="img-fill">
            <div class="text-content"  align="justify">
              <h6>Objective</h6>
              <ul style="padding-left: 5px;">
                <li>To develop various research centres, institutions, residential educational campuses. </li>
                <li> To develop new advance educational system with innovative and advance system.</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-8">
          <div class="service-item wow fadeIn" data-wow-duration="0.75s">
            <div class="text-content"  align="justify">
              ...
              <p>Mr. Ashfaq Mushtak Khan have qualified M.Sc. Chemistry, M.Ed., DSM Lecturer & Career counsellor Founder and Chairman at Sir Einstein Academy, Panchgani and is 
        ...
        <div class="col-md-4">
          <div class="service-item wow fadeIn" data-wow-duration="0.75s">
            <div class="text-content"> <img src="assets/images/trustee/no_image.jpg" class="img-fill">
              <h6 align="center">Ashfaq Mushtak</h6>
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-3">
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                <div class="text-content">
                  <h6 align="center">Mo.Rafik Sir</h6>
            ...
            <div class="col-md-3">
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                <div class="text-content">
                  <h6 align="center">Dr.SAN Inamdar </h6>
                  <p align="center">Associate Director</p>
                </div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                <div class="text-content">
                  <h6 align="center">Sagar Shaikh</h6>
                  <p align="center">Associate Director</p>
                </div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                <div class="text-content">
                  <h6 align="center">Ashraf Anjarlekar</h6>
                  <p align="center">Associate Director</p>
                </div>
              </div>
            </div>
