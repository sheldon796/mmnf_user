...
{  
	...
	echo $sql="INSERT INTO `dept_inq_technobuiz`(`name`, `email`, `subject`, `message`) VALUES ('$name','$email','$subject','$message')";
...
<script> 
        	...
        	window.location.href="dept_technobuiz.php";
...
<div class="Modern-Slider">
  ...
  <div class="item">
    ...
    <div class="img-fill"> <img src="assets/images/MDC_dept/technobuiz_edcation.jpg" alt="" class="img-fill">
      ...
      <div class="info">
        ...
        <div >
          ...
          <h3 style="color:yellow;">Technobuiz-Educational Research And Developement Center</h3>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="car-details">
            ...
            <h4>About Technobuiz Department</h4>

            <span>Activities of Department</span>
            <p>
              <li>Technobuiz is a department for educational research, development, and training.</li>
              <li>Department of educational upliftment.</li>
              <li>Guidance for career, documentation, Admission Process, and Financial needs like scholarship and educational loans.</li>
              <li>To find out talents in the community and support them in a needful manner.</li>
              <li>To research education scenarios and develop a needful curriculum for improvement in the skill and talent of students.</li>
              <li>To develop a global standard institute for teacher training and personality & soft skill development.</li>
              <li>Develop and activate programs, seminars, webinars, and conferences for quality education.</li>
              <li>To improve the percentage of higher educated students.</li>
            </p>

            <!-- <p align="justify">Technobuiz is a Mission for Educational Upliftment, in this mission, we will do research & development, guidance, training from KG to PG and for foreign studies. We will develop Digital university for virtual education. We are giving guidance and training in academics, technology and business also. Basic things of soft skills are not covered in academics so we will develop soft skill training institute also.</p> -->
            ...
            <div class="container">
              ...
              <div class="row">
                ...
                <ul class="car-info col-md-6">
                  ...
                  <li><i class="flaticon"><img src="images/icons/technobuiz/students.png"> </i> <small>Primary Students</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/technobuiz/secondary_stud.png"></i> <small>Secondary Students</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/technobuiz/graduated.png"></i> <small>Graduation Students</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/technobuiz/engineer.png"></i> <small>Engineering Students</small> </li>

                </ul>

                <ul class="car-info col-md-6">

                  <li><i class="flaticon"><img src="images/icons/technobuiz/medical_stud.png"></i> <small>Medical Students</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/technobuiz/phd.png"></i> <small>PHD Students</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/technobuiz/institution.png"></i> <small>Institutions with us</small>

                    <!-- <p>5000</p> -->

                  </li>

                  <li><i class="flaticon"><img src="images/icons/technobuiz/aicu_us.png"></i> <small>AICU with us</small>
          ...
          <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/vision.jpg" class="img-fill">
            ...
            <div class="text-content"  align="justify">
              ...
              <ul style="padding-left: 5px;">
                ...
                <li>To Uplift community by higher education in all sectors. </li>

                <li>To Improve percentage strength of Highly qualified students in each branch.</li>

                <li>To improve Quality of education in all minority institutions.</li>
          ...
          <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/mission.jpg" class="img-fill">
            ...
            <div class="text-content"  align="justify">
              ...
              <ul style="padding-left: 5px;">
                ...
                <li>To build up track record of each student since from first standard. </li>

                <li>Support to get quality education in affordable fees. </li>

                <li>To decrease Drop out percentage of students.</li>

                <li>To create career counselling centres.</li>

                <li>To develop Expert and technician teacher and create Academic intensive care units in each city.</li>

                <li>To tie-up with various standard educational campuses and organisations.</li>
          ...
          <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/goals.jpg" class="img-fill">
            ...
            <div class="text-content"  align="justify">
              ...
              <ul style="padding-left: 5px;">
                ...
                <li> Every student must study upto graduation.</li>

                <li> Develop a best Teachers team in all cities.</li>

                <li> To Develop Digital University.</li>
          ...
          <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/objectives.jpg" class="img-fill">
            ...
            <div class="text-content"  align="justify">
              ...
              <ul style="padding-left: 5px;">
                ...
                <li>To develope various research centres, institutions, residential educational campuses. </li>

                <li> To develope new advance educational system with innovative and advance system.</li>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="service-item wow fadeIn" data-wow-duration="0.75s">
            ...
            <div class="text-content"  align="justify">
              ...
              <p>This Text Will Be Chanage -> Mr. Ashfaq Mushtak Khan have qualified M.Sc. Chemistry, M.Ed., DSM Lecturer & Career counsellor Founder and Chairman at Sir Einstein Academy, Panchgani and is 

                Founder & President at Genius Education Society Mission Director .</p>
        ...
        <div class="col-md-4">
          ...
          <div class="service-item wow fadeIn" data-wow-duration="0.75s">
            ...
            <div class="text-content"> <img src="assets/images/trustee/no_image.jpg" class="img-fill">

              <h6 align="center">Dr.Haji Abdulkarim Salar (Jalgaon)</h6>

              <p align="center">Mission Mentor</p>
              <p align="center">+91 91120 30014</p>
...
<div class="service-item wow fadeIn" data-wow-duration="0.75s">
  ...
  <div class="text-content"> <img src="assets/images/testimonial/Abdulmajid-Nijamuddin.jpg" class="img-fill">

    <h6 align="center">Dr. S. Abdulmajid Nijamuddin Inamdar</h6>

    <p align="center">Mission President</p>
    <p align="center">+91 942-326-9272</p>
        ...
        <div class="col-md-12">
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/Mo-sarfraj-ahmed.jpg" class="img-fill">

                <div class="text-content">

                  <h6 align="center">Mo.sarfraj ahmed (Nanded) </h6>

                  <p align="center">Director</p>
                  <p align="center">+91 9423269272</p>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/Asfak-Khan.jpg" class="img-fill">

                <div class="text-content">

                  <h6 align="center">Asfak Khan (Pachgani)   </h6>

                  <p align="center">Director</p>
                  <p align="center">+91 8080721112</p>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                ...
                <div class="text-content">
                  ...
                  <h6 align="center">Zia Shaikh (Aurangabad) </h6>

                  <p align="center">Director</p>
                  <p align="center">+91 9890388686 </p>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                ...
                <div class="text-content">
                  ...
                  <h6 align="center">Gulambhai Shaikh (Pune) </h6>

                  <p align="center">Director</p>
                  <p align="center">+91 9833786375</p>
            ...
            <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/no_image.jpg" class="img-fill">
                ...
                <div class="text-content">
                  ...
                  <h6 align="center">Iftekar Patel (Usmanabad) </h6>

                  <p align="center">Director</p>
                  <p align="center">+91 8999384949</p>
             ...
             <div class="col-md-3">
              ...
              <div class="service-item wow fadeIn" data-wow-duration="0.75s"> <img src="assets/images/testimonial/Mansur-kazi.jpg" class="img-fill">

                <div class="text-content">

                  <h6 align="center">Mansur kazi <br>(Ratnagiri) </h6>

                  <p align="center">Director</p>
                  <p align="center">+91 93702 69266</p>
        ...
        <div class="col-md-12">
          ...
          <div class="section-heading">
            ...
            <div class="text-content">
              ...
              <h2><strong>Technobuiz With Us</strong></h2>
        ...
        <div class="blog-classic-post">
          ...
          <div class="item">
            ...
            <div class="down-content"> <a href="#">
              ...
              <p>We may try to start Technobuiz centres for Additional coaching,training in soft skills, develop liabrary study room.Interested NGOs,Schools, madrasas  Come to join hands with us.Jobless teachers also join with us.</p>
