...
{    
	...
	echo $sql="INSERT INTO `reg_kabrastan`(`name`, `address`, `taluka`, `district`, `state`, `ap_name`, `ap_mobile`, `ap_designation`, `reg_no`, `reg_upload`, `tp_name`, `tp_mobile`, `tvp_name`, `tvp_mobile`, `s_name`, `s_mobile`, `gs_name`, `gs_mobile`, `tr_name`, `tr_mobile`, `m1_name`, `m1_mobile`, `m2_name`, `m2_mobile`, `m3_name`, `m3_mobile`, `m4_name`, `m4_mobile`, `p_detail`, `c_type`, `area`, `audit`, `compliance`, `if_pending`, `premises`, `expect`, `aff_reg`, `join_mmnf`, `fee_pdf`, `advice`) VALUES ('$name', '$address', '$taluka', '$district', '$state', '$ap_name', '$ap_mobile', '$ap_designation', '$reg_no', '$reg_upload', '$tp_name', '$tp_mobile', '$tvp_name', '$tvp_mobile', '$s_name', '$s_mobile', '$gs_name', '$gs_mobile', '$tr_name', '$tr_mobile', '$m1_name', '$m1_mobile', '$m2_name', '$m2_mobile', '$m3_name', '$m3_mobile', '$m4_name', '$m4_mobile', '$p_detail', '$c_type', '$area', '$audit', '$compliance', '$if_pending', '$premises', '$expect', '$aff_reg', '$join_mmnf', '$fee_pdf', '$advice')";
