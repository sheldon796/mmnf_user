                      ...
                      <form action="" method="post" role="form"  enctype="multipart/form-data">
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <input type="text" onFocus="this.value=''" name="name" id="name" placeholder="Enter Name of NGO">
                          </div>
                          <div class="col-md-12">
                          ...
                          <div class="col-md-12">
                            <label style="color:#ffffff;">MMNF's MDC Registration Number</label>
                            <input type="text" onFocus="this.value=''" name="mdc_reg" id="mdc_reg" placeholder="Enter MRC Registration no">
                          </div>
                          <div class="col-md-12">
                            <label style="color:#ffffff;">Name of Authority Person who manage MRC Responsibility.</label>
                          ...
                          <div class="col-md-6">
                            ...
                            <input type="text" onFocus="this.value=''" name="ap_mobile" id="ap_mobile" placeholder="Enter Mobile +91 xxxxxxxx87">
                          </div>
                          <div class="col-md-6">
                            <label style="color:#ffffff;">Designation of Authority Person</label>
                            <input type="text" onFocus="this.value=''" name="ap_designation" id="ap_designation" placeholder="Enter Degination of Trustee">
                          </div>
                          <div class="col-md-12">
                            <label style="color:#FFFFFF">On Work Time</label>
                            <input type="text" onFocus="this.value=''" name="w_time" id="w_time" placeholder="Enter your  Work Time">
                          </div>
                          <div class="col-md-12">
                            <label style="color:#FFFFFF">Name of care taker/ Dr. of MRC.</label>
                            <input type="text" onFocus="this.value=''" name="d_name" id="d_name" placeholder="Enter the name of care taker/ Dr. of MRC.">
                          </div>
                          <div class="col-md-6">
                            <label style="color:#FFFFFF">Qualification of care taker.</label>
                            <input type="text" onFocus="this.value=''"  name="d_qualification" id="d_qualification" placeholder="Enter the Qualification of care taker">
                          </div>
                          <div class="col-md-6">
                            <label style="color:#FFFFFF">Mobile No Of care taker.</label>
                            <input type="text" onFocus="this.value=''" name="d_mobile" id="d_mobile" placeholder="Enter the Mobile no +91 xxxxxx87">
                          </div>
                          <div class="col-md-12">
                            <label style="color:#FFFFFF">Space Available for MRC, Excluding MDC</label>
                            <input type="text" onFocus="this.value=''" name="space" id="space" placeholder="Enter the area in sq.ft.">
                          </div>
                          <div class="col-md-12">
                            <label style="color:#FFFFFF">Do You Have a pathology lab/ collection center?</label>
                            <input type="text" onFocus="this.value=''" name="lab" id="lab" placeholder="IF yes then type YES | If no the type NO">
                          </div>
                          <style>
													  th{
													  color:#FFFFFF;
                          ...
                          <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                              <tr>
                                <th scope="row">1</th>
                                <td><input type="text" name="p_name" id="p_name" placeholder="Enter Name" style="margin-bottom: 0px;"></td>
                                <td><input type="text" name="p_qualification" id="p_qualification" placeholder="Enter Qualification" style="margin-bottom: 0px;"></td>
                                <td><input type="text" name="p_mobile" id="p_mobile" placeholder="Enter Mobile No" style="margin-bottom: 0px;"></td>
                              </tr>
                            </tbody>
                          </table>
