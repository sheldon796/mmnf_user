...
$name = $_POST['name']; $address = $_POST['address'];  $district = $_POST['district']; $taluka = $_POST['taluka']; $state = $_POST['state']; 


$location = $_POST['location']; $ap_name = $_POST['ap_name']; $ap_mobile = $_POST['ap_mobile']; $ap_designation = $_POST['ap_designation']; $waqf_reg = $_POST['waqf_reg']; $reg_pdf = $_POST['reg_pdf']; $tp_name = $_POST['tp_name']; $tp_mobile = $_POST['tp_mobile']; $tvp_name = $_POST['tvp_name']; $tvp_mobile = $_POST['tvp_mobile']; $s_name = $_POST['s_name']; $s_mobile = $_POST['s_mobile']; $gs_name = $_POST['gs_name']; $gs_mobile = $_POST['gs_mobile']; $tr_name = $_POST['tr_name']; $tr_mobile = $_POST['tr_mobile']; $m1_name = $_POST['m1_name']; $m1_mobile = $_POST['m1_mobile']; $m2_name = $_POST['m2_name']; $m2_mobile = $_POST['m2_mobile']; $m3_name = $_POST['m3_name']; $m3_mobile = $_POST['m3_mobile']; $m4_name = $_POST['m4_name']; $m4_mobile = $_POST['m4_mobile']; $building = $_POST['building']; $c_type = $_POST['c_type']; $area = $_POST['area']; $audit = $_POST['audit']; $compliance = $_POST['compliance']; $if_pending = $_POST['if_pending']; $premises = $_POST['premises']; $expect = $_POST['expect']; $aff_reg = $_POST['aff_reg']; $fee_pdf = $_POST['fee_pdf'];

		 
	echo $sql="INSERT INTO `reg_waqf`(`name`, `address`, `district`, `taluka`, `state`,`location`, `ap_name`, `ap_mobile`, `ap_designation`, `waqf_reg`, `reg_pdf`, `tp_name`, `tp_mobile`, `tvp_name`, `tvp_mobile`, `s_name`, `s_mobile`, `gs_name`, `gs_mobile`, `tr_name`, `tr_mobile`, `m1_name`, `m1_mobile`, `m2_name`, `m2_mobile`, `m3_name`, `m3_mobile`, `m4_name`, `m4_mobile`, `building`, `c_type`, `area`, `audit`, `compliance`, `if_pending`, `premises`, `expect`, `aff_reg`,  `fee_pdf`) VALUES ('$name', '$address', '$district', '$taluka', '$state', '$location', '$ap_name', '$ap_mobile', '$ap_designation', '$waqf_reg', '$reg_pdf', '$tp_name', '$tp_mobile', '$tvp_name', '$tvp_mobile', '$s_name', '$s_mobile', '$gs_name', '$gs_mobile', '$tr_name', '$tr_mobile', '$m1_name', '$m1_mobile', '$m2_name', '$m2_mobile', '$m3_name', '$m3_mobile', '$m4_name', '$m4_mobile', '$building', '$c_type', '$area', '$audit', '$compliance', '$if_pending', '$premises', '$expect', '$aff_reg',  '$fee_pdf',  )";
...
<script> 
        	...
        	window.location.href="ref_waqftrust.php";
        </script>
<?php
	}
	else 
                  ...
                  <div class="search-content">
                    ...
                    <div class="search-form">
                      <form action="" method="post" role="form"  enctype="multipart/form-data">
                        <div class="row">
                          <div class="col-md-12">
                            <label style="color:#FFFFFF">Name of Waqf </label>
                            <input type="text" onFocus="this.value=''" name="name" id="name" placeholder="Enter the name of  Waqf">
                          </div>
                          <div class="col-md-12">
                          ...
                          <div class="col-md-12">
                            ...
                            <input type="text" onFocus="this.value=''" name="ap_name" id="ap_name" placeholder="Enter the name of Authority Person ">
                          </div>
                          <div class="col-md-6">
                            <label style="color:#FFFFFF">Mobile No</label>
                            <input type="text" onFocus="this.value=''" name="ap_mobile" id="ap_mobile"  placeholder="Enter Mobile No +91 xxxxxx88">
                          </div>
                          <div class="col-md-6">
                            <label style="color:#FFFFFF">Degination </label>
                            <input type="text" onFocus="this.value=''" name="ap_designation" id="ap_designation"  placeholder="Degination of Trustee">
                          </div>
                          <div class="col-md-6">
                          ...
                          <div class="col-md-6">
                            <div class="input-select">
                              ...
                              <input name="reg_pdf" id="reg_pdf" type="file" class="form-control-file">
                            </div>
                          </div>
                          <style>
													  th{
                          ...
                          <h5>waqf Trustee Information</h5>
                          <br>
                          <br>
                          ...
                          <div class="col-md-12">
                            <label style="color:#FFFFFF">Enter Building Details </label>
                            <input type="text" onFocus="this.value=''" name="building" id="building" placeholder="Enter Property Details ">
                          </div>
                          <div class="col-md-6">
                          ...
                          <div class="col-md-12">
                            <label style="color:#ffffff;">Do you update Waqf compliance regularly ? (YES/NO) </label>
                          ...
                          <div class="col-md-12">
                            ...
                            <input type="text" onFocus="this.value=''" name="aff_reg" id="aff_reg" placeholder="Do you have trust registration or affiliation with mmnf? ">
                          </div>
